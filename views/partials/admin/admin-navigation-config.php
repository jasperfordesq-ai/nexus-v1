    ...
    return [
            ...
            'columns' => [
                ...
                [
                    ...
                    'items' => [
                        ...
                        ['label' => 'Match Approvals', 'url' => '/admin-legacy/match-approvals', 'icon' => 'fa-clipboard-check', 'badge' => 'NEW'],
        ...
        'enterprise' => [
            ...
            'columns' => [
                ...
                [
                    ...
                    'items' => [
                        ['label' => 'All Documents', 'url' => '/admin-legacy/legal-documents', 'icon' => 'fa-file-contract'],
                        ['label' => 'Compliance Dashboard', 'url' => '/admin-legacy/legal-documents/compliance', 'icon' => 'fa-clipboard-check'],
                    ],
                ],
                [
                    'title' => 'System Health',
        ...
        'system' => [
            ...
            'items' => [
                ...
                ['label' => 'WebP Converter', 'url' => '/admin-legacy/webp-converter', 'icon' => 'fa-image', 'desc' => 'Convert images to WebP format'],
            ],
        ],
