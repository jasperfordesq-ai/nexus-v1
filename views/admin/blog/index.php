...
<div class="nexus-container">
    <div style="display:flex; justify-content:space-between; align-items:center; margin-bottom: 30px;">
        <h1>Manage News</h1>
        <a href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/admin/blog/create" class="nexus-btn-primary">
            + Write Article
        </a>
    </div>
                ...
                <?php foreach ($posts as $post): ?>
                    <tr style="border-bottom: 1px solid #e5e7eb;">
                        <td style="padding: 15px;">
                            <a href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/admin/blog/edit/<?= $post['id'] ?>" style="font-weight: 600; color: #111827; text-decoration: none;">
                        ...
                        <td style="padding: 15px; text-align: right;">
                            <a href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/admin/blog/edit/<?= $post['id'] ?>" class="nexus-btn-secondary" style="padding: 6px 12px; font-size: 0.8rem;">Edit</a>
                            <a href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/admin/blog/builder/<?= $post['id'] ?>" class="nexus-btn-primary" style="padding: 6px 12px; font-size: 0.8rem; margin-left:5px;">Builder</a>
