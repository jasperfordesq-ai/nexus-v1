...
$diskFree = $systemStatus['disk_free'] ?? 'N/A';
$diskTotal = $systemStatus['disk_total'] ?? 'N/A';
$uptime = $systemStatus['uptime'] ?? 'N/A';
$loadAverage = $systemStatus['load_average'] ?? 'N/A';

// Calculate real memory if not provided
if ($memoryUsage === 'N/A') {
...
<div class="monitor-stats-grid">
    ...
    <div class="monitor-stat-card">
        ...
        <div class="monitor-stat-content">
            <div class="monitor-stat-label">Memory Usage</div>
            <div class="monitor-stat-value"><?= htmlspecialchars($memoryUsage) ?></div>
        </div>
        <div class="monitor-stat-sub">of <?= htmlspecialchars($memoryLimit) ?></div>
    </div>
