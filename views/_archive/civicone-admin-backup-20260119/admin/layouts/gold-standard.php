...
$adminModules = [
    ...
    'users' => [
        ...
        'items' => [
            ...
            ['label' => 'Approvals', 'url' => '/admin-legacy/users?filter=pending', 'icon' => 'fa-user-clock'],
            ['label' => 'Badges', 'url' => '/admin-legacy/custom-badges', 'icon' => 'fa-award'],
        ],
    ],
    'content' => [
        'label' => 'Content',
    ...
    'listings' => [
        ...
        'items' => [
            ...
            ['label' => 'Pending Approval', 'url' => '/admin-legacy/listings?status=pending', 'icon' => 'fa-clock'],
        ],
    ],
    'community' => [
        'label' => 'Community',
        ...
        'items' => [
            ['label' => 'Volunteering', 'url' => '/admin-legacy/volunteering', 'icon' => 'fa-hands-helping'],
            ['label' => 'Organizations', 'url' => '/admin-legacy/volunteering/organizations', 'icon' => 'fa-building'],
            ['label' => 'Group Locations', 'url' => '/admin-legacy/group-locations', 'icon' => 'fa-location-dot'],
        ],
    ],
    'engagement' => [
        'label' => 'Engagement',
        'icon' => 'fa-trophy',
        'items' => [
            ['label' => 'Gamification', 'url' => '/admin-legacy/gamification', 'icon' => 'fa-gamepad'],
    ...
    'newsletters' => [
        ...
        'icon' => 'fa-envelope',
        'items' => [
            ['label' => 'All Newsletters', 'url' => '/admin-legacy/newsletters', 'icon' => 'fa-envelopes-bulk'],
    ...
    'ai' => [
        ...
        'items' => [
            ...
            ['label' => 'Feed Algorithm', 'url' => '/admin-legacy/feed-algorithm', 'icon' => 'fa-sliders'],
        ],
    ],
    'timebanking' => [
        'label' => 'Timebanking',
        ...
        'items' => [
            ['label' => 'Dashboard', 'url' => '/admin-legacy/timebanking', 'icon' => 'fa-gauge'],
            ['label' => 'Alerts', 'url' => '/admin-legacy/timebanking/alerts', 'icon' => 'fa-triangle-exclamation'],
    ...
    'enterprise' => [
        ...
        'items' => [
            ['label' => 'Overview', 'url' => '/admin-legacy/enterprise', 'icon' => 'fa-chart-pie'],
            ['label' => 'GDPR', 'url' => '/admin-legacy/enterprise/gdpr', 'icon' => 'fa-user-shield'],
            ['label' => 'Monitoring', 'url' => '/admin-legacy/enterprise/monitoring', 'icon' => 'fa-heart-pulse'],
            ['label' => 'Configuration', 'url' => '/admin-legacy/enterprise/config', 'icon' => 'fa-gears'],
        ],
    ],
    'system' => [
        'label' => 'System',
