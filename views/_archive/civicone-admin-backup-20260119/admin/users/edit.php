    ...
    <div class="admin-card-body">
        ...
        <form action="<?= $basePath ?>/admin-legacy/users/update" method="POST">
            ...
            <div class="admin-form-section admin-form-section-highlight">
                ...
                <div class="admin-form-grid">
                    <div class="admin-form-group">
                        ...
                        <select name="role" class="admin-select" id="role-select">
                            ...
                            <option value="super_admin" <?= $user['role'] === 'admin' && $userIsSuperAdmin ? 'selected' : '' ?>>Super Admin (Platform-Wide)</option>
                            <?php endif; ?>
                        </select>
                        <p class="admin-form-hint">Newsletter Admins can only access the newsletter module. Full Admins have complete access. Super Admins can access all tenants.</p>
                    </div>
                    <div class="admin-form-group">
                ...
                <div class="admin-super-admin-grant" id="super-admin-grant" style="display: <?= $user['role'] === 'admin' ? 'block' : 'none' ?>;">
...
(function() {
    ...
    if (roleSelect && superAdminGrant) {
        roleSelect.addEventListener('change', function() {
            // Show checkbox only for regular admin role, not for super_admin option
            if (this.value === 'admin') {
