...
<div class="admin-page-header">
    <div class="admin-page-header-content">
        ...
        <p class="admin-page-subtitle">Add a new category to organize your content</p>
    </div>
</div>
...
<div class="admin-glass-card" style="max-width: 700px;">
    <div class="admin-card-header">
        ...
        <div class="admin-card-header-content">
            ...
            <p class="admin-card-subtitle">Configure the new category settings</p>
        </div>
    </div>
    <div class="admin-card-body">
        <form action="<?= $basePath ?>/admin-legacy/categories/store" method="POST">
            <input type="hidden" name="csrf_token" value="<?= Csrf::generate() ?>">

            <div class="form-group">
                <label for="name">Category Name *</label>
                <input type="text" id="name" name="name" required placeholder="e.g. Community Support">
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <select id="type" name="type" required>
                        <option value="listing">Listing (Offer/Request)</option>
                        <option value="vol_opportunity">Volunteering Opportunity</option>
            ...
            <div class="color-preview-container">
                ...
                <div class="color-preview">
                    <span class="category-badge" id="colorPreview">Category Name</span>
                </div>
            </div>
