...
<form id="createRoleForm">
    ...
    <div class="form-section">
        <div class="form-section-header">
            ...
            <div class="form-section-title">
                ...
                <p>Enter the role name, identifier, and description</p>
            </div>
        </div>
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                >
                <span class="form-hint">Unique identifier (lowercase, underscores)</span>
            </div>
    ...
    <div class="form-section">
        <div class="form-section-header">
            ...
            <div class="form-section-title">
                <h3>Permissions</h3>
                <p>Select which permissions this role should have</p>
            </div>
                ...
                <div class="permission-category">
                    ...
                    <div class="permissions-list">
                        <?php foreach ($permissions as $perm): ?>
                            <label class="permission-checkbox-item" data-category="<?= htmlspecialchars($category) ?>">
                                <input
                                    type="checkbox"
                                    name="permissions[]"
                                    value="<?= $perm['id'] ?>"
    ...
    try {
        ...
        if (result.success) {
            if (window.AdminRealTime) {
                AdminRealTime.showToast('Role created successfully!', 'success');
            } else {
        ...
        if (window.AdminRealTime) {
            AdminRealTime.showToast(error.message || 'Failed to create role', 'error');
        } else {
        ...
        submitBtn.innerHTML = '<i class="fa-solid fa-plus"></i> Create Role';
    }
});

// Auto-generate slug from display name
document.querySelector('input[name="display_name"]').addEventListener('input', function() {
    const slugInput = document.querySelector('input[name="name"]');
