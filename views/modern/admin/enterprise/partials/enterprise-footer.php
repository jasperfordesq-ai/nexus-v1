...
(function() {
    ...
    const msg = <?= json_encode(htmlspecialchars($_GET['msg'], ENT_QUOTES, 'UTF-8'), JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) ?>;
    const [text, type] = messages[msg] || ['Unknown message', 'info'];
