...
$formData = $_SESSION['form_data'] ?? $document;
...
<div class="admin-page-header">
    <div class="admin-page-header-content">
        <h1 class="admin-page-title">
            ...
            Edit <?= htmlspecialchars($document['title']) ?>
        </h1>
        <p class="admin-page-subtitle">Update document settings (content is managed via versions)</p>
    </div>
</div>
            ...
            <div class="admin-glass-card">
                ...
                <div class="admin-card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" value="<?= htmlspecialchars($document['document_type']) ?>" disabled>
                        <p class="form-help">Document type cannot be changed after creation</p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-help">Changing this will update the public URL</p>
                    </div>
                </div>
            </div>
        </div>
