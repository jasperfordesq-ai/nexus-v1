...
$adminPageTitle = 'New Version';
$adminPageSubtitle = $document['title'] ?? 'Legal Document';
...
<div class="admin-page-header">
    <div class="admin-page-header-content">
        ...
        <p class="admin-page-subtitle">Create a new version of <?= htmlspecialchars($document['title']) ?></p>
    </div>
</div>
...
<form action="<?= $basePath ?>/admin-legacy/legal-documents/<?= $document['id'] ?>/versions" method="POST" class="version-form">
    <?= Csrf::input() ?>
            ...
            <div class="admin-glass-card">
                ...
                <div class="admin-card-body">
                    <div class="form-group">
                        ...
                        <textarea name="content" id="content" class="form-textarea form-textarea-large" required><?= htmlspecialchars($formData['content'] ?? $currentVersion['content'] ?? '') ?></textarea>
            ...
            <div class="admin-glass-card" style="margin-top: 1.5rem;">
                ...
                <div class="admin-card-body">
                    <div class="form-group">
                        ...
                        <textarea name="summary_of_changes" id="summary_of_changes" class="form-textarea" rows="3" placeholder="e.g., Updated liability section to address insurance requirements, added reviews and feedback policy"><?= htmlspecialchars($formData['summary_of_changes'] ?? '') ?></textarea>
                        <p class="form-help">This is shown to users when notifying them of updates and in the version history.</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="admin-form-sidebar">
                ...
                <div class="admin-card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="version_number" id="version_number" class="form-input"
                               value="<?= htmlspecialchars($formData['version_number'] ?? $suggestedVersion ?? '1.0') ?>"
                               placeholder="e.g., 2.0" required pattern="\d+(\.\d+)*">
                    ...
                    <div class="form-group">
                        ...
                        <p class="form-help">Human-readable name for this version</p>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="date" name="effective_date" id="effective_date" class="form-input"
                               value="<?= htmlspecialchars($formData['effective_date'] ?? date('Y-m-d')) ?>" required>
                        <p class="form-help">When this version takes effect</p>
                    </div>
                </div>
            </div>
            ...
            <div class="admin-glass-card" style="margin-top: 1rem;">
                ...
                <div class="admin-card-body">
                    <div class="form-group">
                        ...
                        <p class="form-help">If unchecked, the version will be saved as a draft for review.</p>
                    </div>

                    <div class="publish-warning">
                        <i class="fa-solid fa-exclamation-triangle"></i>
                        <span>Publishing will make this the current active version and may trigger user notifications.</span>
                    </div>
                </div>
            </div>
            ...
            <div class="form-actions" style="margin-top: 1.5rem;">
                <button type="submit" class="admin-btn admin-btn-primary admin-btn-lg admin-btn-full">
                    <i class="fa-solid fa-save"></i> Create Version
                </button>
...
<div class="admin-glass-card" style="margin-top: 2rem;">
    <div class="admin-card-header">
        ...
        <div class="admin-card-header-content">
            <h3 class="admin-card-title">Current Version Reference</h3>
            <p class="admin-card-subtitle">Version <?= htmlspecialchars($currentVersion['version_number']) ?> content for reference</p>
        </div>
    </div>
    <div class="admin-card-body">
        <div class="version-preview">
            <div class="version-preview-header">
                <span class="version-badge">v<?= htmlspecialchars($currentVersion['version_number']) ?></span>
                <span class="version-date">Effective: <?= date('M j, Y', strtotime($currentVersion['effective_date'])) ?></span>
            </div>
