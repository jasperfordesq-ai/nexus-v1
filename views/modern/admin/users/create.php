    ...
    <div class="admin-card-body">
        <form action="<?= $basePath ?>/admin/users/store" method="POST">
            ...
            <div class="admin-form-section admin-form-section-highlight">
                ...
                <div class="admin-form-grid">
                    <div class="admin-form-group">
                        ...
                        <select name="role" class="admin-select" id="role-select">
                            ...
                            <option value="tenant_admin" <?= ($old['role'] ?? '') === 'tenant_admin' ? 'selected' : '' ?>>Tenant Admin</option>
                            <option value="admin" <?= ($old['role'] ?? '') === 'admin' ? 'selected' : '' ?>>Administrator</option>
                        </select>
                        <p class="admin-form-hint">Newsletter Admins can only access the newsletter module. Tenant Admins manage their tenant. Full Admins have complete access.</p>
                    </div>
                    <div class="admin-form-group">
                ...
                <div class="admin-super-admin-grant" id="super-admin-grant" style="display: <?= in_array($old['role'] ?? '', ['admin', 'tenant_admin']) ? 'block' : 'none' ?>;">
