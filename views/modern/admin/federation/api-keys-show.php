...
<div class="key-detail-page">
    <a href="<?= $basePath ?>/admin-legacy/federation/api-keys" class="back-link">
    ...
    <div class="key-info-card">
        ...
        <div class="key-actions">
            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $apiKey['id'] ?>/regenerate" style="display:inline;">
            ...
            <?php if ($apiKey['status'] === 'active'): ?>
            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $apiKey['id'] ?>/suspend" style="display:inline;">
                <input type="hidden" name="csrf_token" value="<?= Csrf::token() ?>">
            ...
            <?php else: ?>
            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $apiKey['id'] ?>/activate" style="display:inline;">
                <input type="hidden" name="csrf_token" value="<?= Csrf::token() ?>">
            ...
            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $apiKey['id'] ?>/revoke" style="display:inline;">
                <input type="hidden" name="csrf_token" value="<?= Csrf::token() ?>">
