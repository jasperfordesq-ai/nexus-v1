...
<div class="data-dashboard">
    ...
    <div class="section-row">
        ...
        <div class="section-card">
            ...
            <div class="export-options">
                <div class="export-option">
                    ...
                    <a href="<?= $basePath ?>/admin-legacy/federation/export/users" class="export-btn">
                ...
                <div class="export-option">
                    ...
                    <a href="<?= $basePath ?>/admin-legacy/federation/export/partnerships" class="export-btn">
                        <i class="fa-solid fa-download"></i> Export
                    </a>
                </div>
                ...
                <div class="export-option">
                    ...
                    <a href="<?= $basePath ?>/admin-legacy/federation/export/transactions" class="export-btn">
                        <i class="fa-solid fa-download"></i> Export
                    </a>
                </div>
                ...
                <div class="export-option">
                    ...
                    <a href="<?= $basePath ?>/admin-legacy/federation/export/audit" class="export-btn">
                        <i class="fa-solid fa-download"></i> Export
                    </a>
                </div>
            </div>
            ...
            <div class="full-backup-section">
                <a href="<?= $basePath ?>/admin-legacy/federation/export/all" class="full-backup-btn">
        ...
        <div class="section-card">
            ...
            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/import/users" enctype="multipart/form-data" class="import-form">
                ...
                <div class="form-group">
                    ...
                    <p class="hint">
                        ...
                        <a href="<?= $basePath ?>/admin-legacy/federation/import/template" style="color: #8b5cf6;">Download template</a>
                    </p>
                </div>
                ...
                <div class="import-actions">
                    ...
                    <a href="<?= $basePath ?>/admin-legacy/federation/import/template" class="btn btn-secondary">
