...
<div class="api-keys-dashboard">
    ...
    <div class="api-header">
        ...
        <a href="<?= $basePath ?>/admin-legacy/federation/api-keys/create" class="create-key-btn">
                ...
                <tr>
                    ...
                    <td>
                        <div class="key-actions">
                            <a href="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $key['id'] ?>" class="key-action-btn view">
                                <i class="fa-solid fa-eye"></i>
                            </a>
                            <?php if ($key['status'] === 'active'): ?>
                            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $key['id'] ?>/suspend" style="display:inline;">
                            ...
                            <?php elseif ($key['status'] === 'suspended'): ?>
                            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $key['id'] ?>/activate" style="display:inline;">
                                <input type="hidden" name="csrf_token" value="<?= Csrf::token() ?>">
                            ...
                            <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/<?= $key['id'] ?>/revoke" style="display:inline;">
                                <input type="hidden" name="csrf_token" value="<?= Csrf::token() ?>">
