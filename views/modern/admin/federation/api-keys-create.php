...
<div class="create-key-form">
    ...
    <div class="form-card">
        <form method="POST" action="<?= $basePath ?>/admin-legacy/federation/api-keys/store">
            ...
            <div class="form-actions">
                ...
                <a href="<?= $basePath ?>/admin-legacy/federation/api-keys" class="btn btn-secondary">Cancel</a>
            </div>
        </form>
    </div>
</div>
