...
<style>
    ...
    */
        ...
        --sidebar-border: 1px solid rgba(255, 255, 255, 0.4);

        /* Date Badge Variables */
        --date-badge-bg: rgba(255, 237, 213, 0.6);
        --date-badge-border: 1px solid rgba(253, 186, 116, 0.5);
        --date-text: #c2410c;
...
*/
    ...
    html[data-theme="dark"] #unique-glass-page-wrapper {
        ...
        --sidebar-bg: rgba(24, 24, 27, 0.4);
        --sidebar-border: 1px solid rgba(255, 255, 255, 0.1);

        --date-badge-bg: rgba(67, 20, 7, 0.6);
        --date-badge-border: 1px solid rgba(251, 146, 60, 0.3);
        --date-text: #fdba74;
    ...
    /* Layout Grid */
    #unique-glass-page-wrapper .event-layout {
        display: grid;
    ...
    /* Main Content Area */
    #unique-glass-page-wrapper .main-content {
        display: flex;
        flex-direction: column;
    }
    ...
    #unique-glass-page-wrapper .host-byline {
        font-size: 1.1rem;
    ...
    /* Date Badge (Floating Card) */
    #unique-glass-page-wrapper .glass-date-badge {
        display: flex;
        align-items: center;
        gap: 20px;
        background: var(--date-badge-bg);
        border: var(--date-badge-border);
        color: var(--date-text);
        padding: 20px 25px;
        border-radius: 20px;
        margin-bottom: 30px;
    ...
    #unique-glass-page-wrapper .date-block {
        text-align: center;
        padding-right: 20px;
        border-right: 1px solid rgba(255, 255, 255, 0.2);
    }

    #unique-glass-page-wrapper .date-month {
    ...
    #unique-glass-page-wrapper .date-day {
        font-size: 2.5rem;
        font-weight: 800;
        line-height: 1;
    }

    #unique-glass-page-wrapper .time-loc {
        display: flex;
        flex-direction: column;
        gap: 5px;
    }

    #unique-glass-page-wrapper .time-text {
        font-size: 1.2rem;
        font-weight: 700;
    }

    #unique-glass-page-wrapper .loc-text {
        font-size: 1rem;
        opacity: 0.9;
    }

    /* Description */
    #unique-glass-page-wrapper .description {
        font-size: 1.1rem;
        line-height: 1.7;
        color: var(--text-color);
    ...
    /* SDG Pills */
    #unique-glass-page-wrapper .sdg-container {
        display: flex;
        flex-wrap: wrap;
        gap: 10px;
        margin-bottom: 30px;
    ...
    #unique-glass-page-wrapper .glass-sdg-pill {
        padding: 6px 14px;
        border-radius: 50px;
        font-size: 0.85rem;
        font-weight: 600;
    ...
    /* Sidebar */
    #unique-glass-page-wrapper .sidebar {
        display: flex;
        flex-direction: column;
        gap: 25px;
    }

    #unique-glass-page-wrapper .sidebar-card {
    ...
    #unique-glass-page-wrapper .sidebar-title {
        margin: 0 0 15px 0;
        font-size: 1.1rem;
        font-weight: 700;
        color: var(--text-color);
    ...
    /* RSVP Buttons */
    #unique-glass-page-wrapper .rsvp-actions {
        display: flex;
        gap: 10px;
    }

    #unique-glass-page-wrapper .glass-btn {
        flex: 1;
        padding: 10px;
        border-radius: 12px;
        border: none;
    ...
    #unique-glass-page-wrapper .glass-btn:hover {
    ...
    #unique-glass-page-wrapper .glass-btn.danger {
    ...
    /* Attendee List */
    #unique-glass-page-wrapper .attendee-item {
        display: flex;
        align-items: center;
        gap: 12px;
        padding: 10px 0;
    ...
    #unique-glass-page-wrapper .attendee-item:last-child {
        border-bottom: none;
    }

    #unique-glass-page-wrapper .avatar {
        width: 36px;
        height: 36px;
        border-radius: 50%;
        object-fit: cover;
    ...
    /* Modal Overlay */
    #unique-glass-page-wrapper .glass-modal-overlay {
        display: none;
        position: fixed;
        top: 0;
        left: 0;
    ...
    #unique-glass-page-wrapper .glass-modal-content {
        background: var(--glass-bg);
        border: 1px solid var(--glass-border);
        border-radius: 28px;
        padding: 40px;
