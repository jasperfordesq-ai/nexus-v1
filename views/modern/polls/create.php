...
<style>
/* ============================================
   HOLOGRAPHIC GLASSMORPHISM CREATE POLL
...
.holo-add-option-btn:hover {
    background: rgba(139, 92, 246, 0.15);
    border-color: rgba(139, 92, 246, 0.5);
    transform: translateY(-2px);
}

[data-theme="dark"] .holo-add-option-btn {
    background: rgba(139, 92, 246, 0.15);
    color: #a78bfa;
}
...
.holo-add-option-btn:focus-visible {
