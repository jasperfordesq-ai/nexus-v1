...
<div class="govuk-grid-row govuk-!-margin-bottom-6">
    ...
    <div class="govuk-grid-column-one-third">
        <div class="govuk-!-padding-4 civicone-accent-card--green civicone-flex-card">
            ...
            <a href="<?= $basePath ?>/hse-case-study" class="govuk-button govuk-button--green" data-module="govuk-button">
    ...
    <div class="govuk-grid-column-one-third">
        <div class="govuk-!-padding-4 civicone-action-card civicone-flex-card">
            <h3 class="govuk-heading-m civicone-heading-blue">
    ...
    <!-- Resilient Towns -->
    <div class="govuk-grid-column-one-third">
        <div class="govuk-!-padding-4 civicone-accent-card--orange civicone-flex-card">
            <h3 class="govuk-heading-m civicone-heading-orange">
