...
<main class="civic-container" style="padding: 40px 20px;">
    ...
    <header style="margin-bottom: 40px; border-bottom: 1px solid #e2e8f0; padding-bottom: 20px;">
        <span class="civic-bg-blue-50" style="color: var(--skin-primary, #002d72); padding: 6px 12px; border-radius: 20px; font-weight: 600; font-size: 0.9rem;">Security & Standards</span>
        <h1 style="color: #002d72; margin-top: 15px; font-size: 2.5rem;">Government-Grade Infrastructure</h1>
        <p class="civic-text-medium" style="font-size: 1.2rem;">Security That Meets National Standards.</p>
    </header>

    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 40px;">

        <div>
            <p class="civic-text-dark" style="font-size: 1.1rem; line-height: 1.7; margin-bottom: 30px;">
            ...
            <div style="margin-bottom: 30px;">
                <h3 style="color: #1e293b; display: flex; align-items: center; gap: 10px;">
                    <span class="civic-bg-green-50 civic-text-green-dark" style="width: 30px; height: 30px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">✓</span>
                    GDPR & Multi-Tenancy
                </h3>
                <p class="civic-text-medium" style="margin-left: 40px;">
        ...
        <div style="background: #f8fafc; padding: 25px; border-radius: 12px; height: fit-content; border: 1px solid #e2e8f0;">
            ...
            <ul class="civic-text-light" style="padding-left: 20px; line-height: 1.8;">
            ...
            <a href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/technical-specs" class="civic-btn civic-text-dark" style="display: block; text-align: center; margin-top: 20px; background: white; border: 1px solid #cbd5e1; text-decoration: none; padding: 10px; border-radius: 6px; font-weight: 600;">View Full Proposal</a>
        </div>
