...
<div class="govuk-grid-row">
    <div class="govuk-grid-column-two-thirds">
        ...
        <div class="govuk-!-margin-bottom-6">
            ...
            ?>
                <div class="govuk-!-margin-bottom-4 govuk-!-padding-4 <?= $isMe ? 'civicone-post-me' : 'civicone-post-other' ?>">
                    <div class="civicone-post-header">
                        <?php if (!empty($post['author_avatar'])): ?>
                            <img src="<?= htmlspecialchars($post['author_avatar']) ?>" loading="lazy" alt="" class="civicone-avatar-sm">
                        <?php else: ?>
                            <div class="civicone-avatar-placeholder">
                                <?= strtoupper(substr($post['author_name'], 0, 1)) ?>
                            </div>
                        <?php endif; ?>
                        <div>
                            <p class="govuk-body-s govuk-!-margin-bottom-0 govuk-!-font-weight-bold"><?= htmlspecialchars($post['author_name']) ?></p>
                            <p class="govuk-body-s govuk-!-margin-bottom-0 civicone-secondary-text"><?= date('j M Y, g:i A', strtotime($post['created_at'])) ?></p>
                        </div>
                    </div>
    ...
    <div class="govuk-grid-column-one-third">
        <div class="govuk-!-padding-4 civicone-card-bordered-simple">
