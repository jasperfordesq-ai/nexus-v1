...
<link rel="stylesheet" href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/assets/css/purged/civicone-organizations-transfer-requests.min.css">
            ...
            <tbody id="requestsBody">
                ...
                <tr data-status="<?= $request['status'] ?>">
                    ...
                    <td data-label="Recipient">
                        <div class="request-user">
                            <div class="request-avatar request-avatar--recipient">
                    ...
                    <td data-label="Actions">
                        ...
                        <div class="request-actions">
                            <form action="<?= \Nexus\Core\TenantContext::getBasePath() ?>/organizations/<?= $org['id'] ?>/wallet/approve/<?= $request['id'] ?>" method="POST" class="request-form-inline">
                                <?= \Nexus\Core\Csrf::input() ?>
                                <button type="submit" class="request-btn approve">
                                    <i class="fa-solid fa-check"></i> Approve
                                </button>
                            </form>
                            <form action="<?= \Nexus\Core\TenantContext::getBasePath() ?>/organizations/<?= $org['id'] ?>/wallet/reject/<?= $request['id'] ?>" method="POST" class="request-form-inline"
                        ...
                        <?php else: ?>
                        <span class="request-no-action">-</span>
                        <?php endif; ?>
                    </td>
                </tr>
                <?php endforeach; ?>
...
<script src="<?= \Nexus\Core\TenantContext::getBasePath() ?>/assets/js/civicone-organizations-transfer-requests.min.js" defer></script>
