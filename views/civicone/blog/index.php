...
<style>
   ...
   ============================================ */
    ...
    #news-holo-wrapper .news-card:nth-child(1) {
        animation-delay: 0.1s;
    }

    #news-holo-wrapper .news-card:nth-child(2) {
        animation-delay: 0.15s;
    }

    #news-holo-wrapper .news-card:nth-child(3) {
        animation-delay: 0.2s;
    }

    #news-holo-wrapper .news-card:nth-child(4) {
        animation-delay: 0.25s;
    }

    #news-holo-wrapper .news-card:nth-child(5) {
        animation-delay: 0.3s;
    }

    #news-holo-wrapper .news-card:nth-child(6) {
    ...
    /* ============================================
   HOLOGRAPHIC GLASSMORPHISM NEWS 2025
   ...
   ============================================ */
    ...
    #news-holo-wrapper::after {
        ...
        background:
            ...
            radial-gradient(ellipse at 0% 50%, rgba(139, 92, 246, 0.15) 0%, transparent 40%),
            radial-gradient(ellipse at 100% 50%, rgba(6, 182, 212, 0.15) 0%, transparent 40%);
    ...
    [data-theme="light"] #news-holo-wrapper {
        --bg-override: #f8fafc;
    }
