...
<div class="govuk-grid-row govuk-!-margin-bottom-6">
    ...
    <div class="govuk-grid-column-one-third">
        <div class="govuk-!-padding-4 civicone-panel-bg civicone-xp-balance-card">
            <p class="govuk-body-s govuk-!-margin-bottom-1 civicone-secondary-text">Your XP Balance</p>
            <p class="govuk-heading-l govuk-!-margin-bottom-0 civicone-heading-blue">
...
<div class="shop-wrapper">
    ...
    <div class="govuk-grid-row">
        ...
        <div class="govuk-grid-column-one-third govuk-!-margin-bottom-6 shop-item-wrapper"
            ...
            <div class="shop-item govuk-!-padding-4 civicone-shop-item civicone-card-relative <?= $item['owned'] ? 'owned civicone-shop-item--owned' : '' ?> <?= ($item['xp_cost'] > $userXP && !$item['owned']) ? 'locked' : '' ?>">

                <?php if ($item['owned']): ?>
                    <span class="govuk-tag govuk-tag--green civicone-tag-positioned">Owned</span>
                <?php elseif ($item['is_limited'] ?? false): ?>
                    <span class="govuk-tag govuk-tag--red civicone-tag-positioned">Limited</span>
                <?php elseif ($item['is_new'] ?? false): ?>
                    <span class="govuk-tag govuk-tag--light-blue civicone-tag-positioned">New</span>
                <?php endif; ?>

                <div class="govuk-!-text-align-centre govuk-!-margin-bottom-3 civicone-icon-xl">
                ...
                <p class="govuk-body-s civicone-secondary-text"><?= htmlspecialchars($item['description']) ?></p>

                <hr class="govuk-section-break govuk-section-break--m govuk-section-break--visible">

                <div class="civicone-shop-price-row">
                    <span class="govuk-body govuk-!-font-weight-bold civicone-xp-price">
...
<div class="purchase-modal civicone-modal-overlay" id="purchaseModal">
    <div class="govuk-!-padding-6 civicone-modal-content" role="dialog" aria-modal="true" aria-labelledby="modal-title">
        <div class="govuk-!-text-align-centre govuk-!-margin-bottom-4 civicone-icon-large" id="modalIcon"></div>
        ...
        <div class="govuk-button-group civicone-modal-buttons">
...
<!-- Success Modal -->
<div class="purchase-modal civicone-modal-overlay" id="successModal">
    <div class="govuk-!-padding-6 civicone-modal-content" role="dialog" aria-modal="true" aria-labelledby="success-title">
        <div class="govuk-!-text-align-centre govuk-!-margin-bottom-4 civicone-icon-large" id="successIcon"></div>
