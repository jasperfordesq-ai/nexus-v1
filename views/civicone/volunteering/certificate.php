 ...
 * 
 * Purpose: Display volunteer certificate with holographic design
 * Features: Hour tracking, badge display, print functionality, preview mode
 * WCAG 2.1 AA: Semantic HTML, print styles, accessible tables
 */
...
?>
<link rel="stylesheet" href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/assets/css/purged/civicone-volunteering-certificate.min.css">
    ...
    <div class="vc-container">
        ...
        <div class="vc-card">
            ...
            <div class="vc-empty">
                ...
                <a href="<?= \Nexus\Core\TenantContext::getBasePath() ?>/volunteering" class="vc-btn vc-btn-primary inline-flex">
