...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .tab-btn:hover { border-color: #0b0c0c; }
        .tab-btn.active {
            background: #1d70b8;
            border-color: #1d70b8;
            color: white;
        ...
        .type-btn:hover { background: white; }
        .type-btn.active {
            background: #1d70b8;
            border-color: #1d70b8;
            color: white;
        }
        .type-btn.offer.active { background: #00703c; border-color: #00703c; }
        .type-btn.request.active { background: #912b88; border-color: #912b88; }
        .step-indicator {
            display: flex;
            gap: 8px;
            margin-bottom: 20px;
        ...
        .step-dot.active { background: #1d70b8; }
        .step { display: none; }
        ...
        .poll-option button:hover { background: #aa2a17; }
        @media (max-width: 640px) {
            body { padding: 0; }
            .compose-container { max-height: 100vh; height: 100vh; }
