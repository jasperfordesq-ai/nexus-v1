<?php
// Determine layout (same logic as layouts/header.php)
...
switch ($layout) {
    ...
    case 'civicone':
        require dirname(__DIR__) . '/civicone/notifications/index.php';
        return;

    case 'modern':
    default:
        require dirname(__DIR__) . '/modern/notifications/index.php';
        return;
}
