...
<div id="guide-glass-wrapper">
    ...
    <style>
        ...
        #guide-glass-wrapper .btn--primary {
        ...
        #guide-glass-wrapper .btn--primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 8px 24px rgba(13, 148, 136, 0.4),
                        inset 0 1px 0 rgba(255, 255, 255, 0.3);
        }

        #guide-glass-wrapper .btn--secondary {
            background: linear-gradient(135deg,
                rgba(255, 255, 255, 0.75),
                rgba(255, 255, 255, 0.6));
        ...
        #guide-glass-wrapper .btn--secondary:hover {
            transform: translateY(-2px);
            border-color: rgba(13, 148, 136, 0.5);
            background: rgba(255, 255, 255, 0.85);
        }

        [data-theme="dark"] #guide-glass-wrapper .btn--secondary {
            background: linear-gradient(135deg,
                rgba(15, 23, 42, 0.6),
                rgba(30, 41, 59, 0.5));
            border-color: rgba(13, 148, 136, 0.4);
        ...
        [data-theme="dark"] #guide-glass-wrapper .btn--secondary:hover {
        ...
        <div class="card-body">
            <div class="cta-box">
                ...
                <div style="display: flex; gap: 16px; justify-content: center; flex-wrap: wrap;">
                    <a href="<?= $basePath ?>/partner" class="btn btn--primary">
                        🤝 Partner With Us
                    </a>
                    <a href="<?= $basePath ?>/impact-report" class="btn btn--secondary">
                        📊 View Full Report
                    </a>
                </div>
            </div>
