<?php
// Phoenix View: Mobile Download
$pageTitle = 'Download the App';
$hideHero = true;
...
<style>
    ...
    /* Desktop: Clear fixed header (utility bar 52px + navbar ~94px = ~146px) */
    ...
    .install-step-text {
        font-size: 0.9rem;
        color: var(--htb-text-muted, #4b5563);
        line-height: 1.5;
    }
    ...
    [data-theme="dark"] .warning-note-text {
        color: #fbbf24;
    }

    [data-theme="dark"] .pwa-alternative {
...
<div class="mobile-download-page">
    ...
    <div class="download-header">
        <div class="download-header-icon">
            <img src="/assets/images/pwa/icon-192x192.png" alt="Hour Timebank">
        </div>
        <h1>Hour Timebank for Android</h1>
    ...
    <div class="download-section android-only" id="androidSection">
        ...
        <a href="/downloads/nexus-latest.apk" class="download-btn" id="downloadBtn">
    ...
    <!-- iOS Message (hidden by default, shown via JS) -->
    <div class="download-section ios-only" id="iosSection">
        ...
        <p style="color: var(--htb-text-muted, #6b7280); margin: 0 0 16px; line-height: 1.6;">
            The Android APK won't work on iOS devices. But don't worry - you can add Hour Timebank to your home screen for the same app-like experience!
        </p>
