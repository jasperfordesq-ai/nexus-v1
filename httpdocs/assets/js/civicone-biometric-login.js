/**
 * CivicOne Biometric Login (WebAuthn)
...
(function() {
    ...
    async function checkBiometricSupport() {
        const container = document.getElementById('civicone-biometric-container');
        const promo = document.getElementById('civicone-biometric-promo');
    ...
    async function attemptBiometricLogin() {
        const btn = document.getElementById('civicone-biometric-btn');
    ...
    // Public API
    // ============================================
    window.civiconeBiometric = {
        check: checkBiometricSupport,
        login: attemptBiometricLogin
    };
