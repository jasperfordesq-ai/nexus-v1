...
*This report documents the complete goals & impact module engine as implemented in Project NEXUS v1.5.2. For the most current implementation, refer to the source files listed in Section 2.*
