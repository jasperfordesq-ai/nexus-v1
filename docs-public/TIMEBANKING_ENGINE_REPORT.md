...
*This report documents the complete timebanking engine as implemented in Project NEXUS v1.5.2. For the most current implementation details, refer to the source code files listed in Section 3.*
