...
/**
 * MobileAppController — Eloquent-powered mobile app version checks and logging.
 *
 * Fully migrated from legacy delegation to native Laravel.
 * Handles version checking, update prompts, and app-specific logging.
 */
class MobileAppController extends BaseApiController
{
    ...
    public function log(): JsonResponse
    {
        ...
        return $this->respondWithData(['logged' => true]);
    }
}
