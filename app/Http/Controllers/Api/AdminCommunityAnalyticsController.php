...
class AdminCommunityAnalyticsController extends BaseApiController
{
    ...
    {
        return $this->delegate(\Nexus\Controllers\Api\AdminCommunityAnalyticsApiController::class, 'index');
    }

    /** GET /api/v2/admin/community-analytics/export */
    public function export(): JsonResponse
    {
        return $this->delegate(\Nexus\Controllers\Api\AdminCommunityAnalyticsApiController::class, 'export');
    }

    /** GET /api/v2/admin/community-analytics/geography */
    public function geography(): JsonResponse
    {
        return $this->delegate(\Nexus\Controllers\Api\AdminCommunityAnalyticsApiController::class, 'geography');
    }
}
