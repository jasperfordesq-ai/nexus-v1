...
use App\Services\PublicStaticRouteContentService;
use Illuminate\Http\JsonResponse;

class PublicStaticRouteContentController extends BaseApiController
{
    protected bool $isV2Api = true;

    public function __construct(
        private readonly PublicStaticRouteContentService $content,
    ) {
    }
