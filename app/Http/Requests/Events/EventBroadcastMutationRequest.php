...
/** Enforces one replay-safe key from the header or body, never conflicting copies. */
abstract class EventBroadcastMutationRequest extends EventBroadcastFormRequest
{
    ...
    {
        return ['idempotency_key' => ['required', 'string', 'max:191']];
    }
