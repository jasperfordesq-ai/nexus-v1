...
Route::get('/v2/admin/email-deliverability/push-summary',     [\App\Http\Controllers\Api\AdminEmailDeliverabilityController::class, 'pushSummary'])->middleware(['auth:sanctum', 'admin']);
