...
Route::get('/v2/admin/volunteering/expenses', [\App\Http\Controllers\Api\VolunteerController::class, 'adminExpenses']);
Route::put('/v2/admin/volunteering/expenses/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'reviewExpense']);
Route::get('/v2/admin/volunteering/expenses/export', [\App\Http\Controllers\Api\VolunteerController::class, 'exportExpenses']);
Route::get('/v2/admin/volunteering/expenses/policies', [\App\Http\Controllers\Api\VolunteerController::class, 'getExpensePolicies']);
Route::put('/v2/admin/volunteering/expenses/policies', [\App\Http\Controllers\Api\VolunteerController::class, 'updateExpensePolicy']);
Route::get('/v2/admin/volunteering/guardian-consents', [\App\Http\Controllers\Api\VolunteerController::class, 'adminGuardianConsents']);
Route::get('/v2/admin/volunteering/training', [\App\Http\Controllers\Api\VolunteerController::class, 'adminTraining']);
Route::put('/v2/admin/volunteering/training/{id}/verify', [\App\Http\Controllers\Api\VolunteerController::class, 'verifyTraining']);
Route::put('/v2/admin/volunteering/training/{id}/reject', [\App\Http\Controllers\Api\VolunteerController::class, 'rejectTraining']);
Route::get('/v2/admin/volunteering/incidents', [\App\Http\Controllers\Api\VolunteerController::class, 'adminIncidents']);
Route::put('/v2/admin/volunteering/incidents/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'updateIncident']);
Route::put('/v2/admin/volunteering/organizations/{id}/dlp', [\App\Http\Controllers\Api\VolunteerController::class, 'assignDlp']);
Route::get('/v2/admin/volunteering/custom-fields', [\App\Http\Controllers\Api\VolunteerController::class, 'adminCustomFields']);
Route::post('/v2/admin/volunteering/custom-fields', [\App\Http\Controllers\Api\VolunteerController::class, 'createCustomField']);
Route::put('/v2/admin/volunteering/custom-fields/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'updateCustomField']);
Route::delete('/v2/admin/volunteering/custom-fields/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'deleteCustomField']);
Route::get('/v2/admin/volunteering/reminder-settings', [\App\Http\Controllers\Api\VolunteerController::class, 'getReminderSettings']);
Route::put('/v2/admin/volunteering/reminder-settings', [\App\Http\Controllers\Api\VolunteerController::class, 'updateReminderSettings']);
Route::put('/v2/admin/volunteering/community-projects/{id}/review', [\App\Http\Controllers\Api\VolunteerController::class, 'reviewCommunityProject']);
Route::get('/v2/admin/volunteering/webhooks', [\App\Http\Controllers\Api\VolunteerController::class, 'getWebhooks']);
Route::post('/v2/admin/volunteering/webhooks', [\App\Http\Controllers\Api\VolunteerController::class, 'createWebhook']);
Route::put('/v2/admin/volunteering/webhooks/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'updateWebhook']);
Route::delete('/v2/admin/volunteering/webhooks/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'deleteWebhook']);
Route::post('/v2/admin/volunteering/webhooks/{id}/test', [\App\Http\Controllers\Api\VolunteerController::class, 'testWebhook']);
Route::get('/v2/admin/volunteering/webhooks/{id}/logs', [\App\Http\Controllers\Api\VolunteerController::class, 'getWebhookLogs']);
Route::get('/v2/admin/volunteering/giving-days', [\App\Http\Controllers\Api\VolunteerController::class, 'adminGivingDays']);
Route::post('/v2/admin/volunteering/giving-days', [\App\Http\Controllers\Api\VolunteerController::class, 'createGivingDay']);
Route::put('/v2/admin/volunteering/giving-days/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'updateGivingDay']);
Route::get('/v2/admin/volunteering/donations/export', [\App\Http\Controllers\Api\VolunteerController::class, 'exportDonations']);
...
Route::get('/v2/volunteering/emergency-alerts', [\App\Http\Controllers\Api\VolunteerController::class, 'myEmergencyAlerts']);
Route::post('/v2/volunteering/emergency-alerts', [\App\Http\Controllers\Api\VolunteerController::class, 'createEmergencyAlert']);
Route::put('/v2/volunteering/emergency-alerts/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'respondToEmergencyAlert']);
Route::delete('/v2/volunteering/emergency-alerts/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'cancelEmergencyAlert']);
Route::get('/v2/volunteering/wellbeing', [\App\Http\Controllers\Api\VolunteerController::class, 'wellbeingDashboard']);
Route::post('/v2/volunteering/wellbeing/checkin', [\App\Http\Controllers\Api\VolunteerController::class, 'wellbeingCheckin']);
Route::get('/v2/volunteering/wellbeing/my-status', [\App\Http\Controllers\Api\VolunteerController::class, 'myWellbeingStatus']);
Route::get('/v2/volunteering/swaps', [\App\Http\Controllers\Api\VolunteerController::class, 'getSwapRequests']);
Route::post('/v2/volunteering/swaps', [\App\Http\Controllers\Api\VolunteerController::class, 'requestSwap']);
Route::put('/v2/volunteering/swaps/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'respondToSwap']);
Route::delete('/v2/volunteering/swaps/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'cancelSwap']);
Route::get('/v2/volunteering/my-waitlists', [\App\Http\Controllers\Api\VolunteerController::class, 'myWaitlists']);
Route::post('/v2/volunteering/shifts/{id}/waitlist', [\App\Http\Controllers\Api\VolunteerController::class, 'joinWaitlist']);
Route::delete('/v2/volunteering/shifts/{id}/waitlist', [\App\Http\Controllers\Api\VolunteerController::class, 'leaveWaitlist']);
Route::post('/v2/volunteering/shifts/{id}/waitlist/promote', [\App\Http\Controllers\Api\VolunteerController::class, 'promoteFromWaitlist']);
Route::get('/v2/volunteering/group-reservations', [\App\Http\Controllers\Api\VolunteerController::class, 'myGroupReservations']);
Route::post('/v2/volunteering/shifts/{id}/group-reserve', [\App\Http\Controllers\Api\VolunteerController::class, 'groupReserve']);
Route::post('/v2/volunteering/group-reservations/{id}/members', [\App\Http\Controllers\Api\VolunteerController::class, 'addGroupMember']);
Route::delete('/v2/volunteering/group-reservations/{id}/members/{userId}', [\App\Http\Controllers\Api\VolunteerController::class, 'removeGroupMember']);
Route::delete('/v2/volunteering/group-reservations/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'cancelGroupReservation']);
Route::get('/v2/volunteering/shifts/{id}/checkin', [\App\Http\Controllers\Api\VolunteerController::class, 'getCheckIn']);
Route::post('/v2/volunteering/checkin/verify/{token}', [\App\Http\Controllers\Api\VolunteerController::class, 'verifyCheckIn']);
Route::post('/v2/volunteering/checkin/checkout/{token}', [\App\Http\Controllers\Api\VolunteerController::class, 'checkOut']);
Route::get('/v2/volunteering/shifts/{id}/checkins', [\App\Http\Controllers\Api\VolunteerController::class, 'shiftCheckIns']);
Route::get('/v2/volunteering/opportunities/{id}/recurring-patterns', [\App\Http\Controllers\Api\VolunteerController::class, 'recurringPatterns']);
Route::post('/v2/volunteering/opportunities/{id}/recurring-patterns', [\App\Http\Controllers\Api\VolunteerController::class, 'createRecurringPattern']);
Route::put('/v2/volunteering/recurring-patterns/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'updateRecurringPattern']);
Route::delete('/v2/volunteering/recurring-patterns/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'deleteRecurringPattern']);
Route::get('/v2/volunteering/expenses', [\App\Http\Controllers\Api\VolunteerController::class, 'myExpenses']);
Route::post('/v2/volunteering/expenses', [\App\Http\Controllers\Api\VolunteerController::class, 'submitExpense']);
...
Route::post('/v2/volunteering/incidents', [\App\Http\Controllers\Api\VolunteerController::class, 'reportIncident']);
Route::get('/v2/volunteering/incidents', [\App\Http\Controllers\Api\VolunteerController::class, 'getIncidents']);
Route::get('/v2/volunteering/incidents/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'getIncident']);
Route::get('/v2/volunteering/custom-fields', [\App\Http\Controllers\Api\VolunteerController::class, 'getCustomFields']);
Route::get('/v2/volunteering/accessibility-needs', [\App\Http\Controllers\Api\VolunteerController::class, 'myAccessibilityNeeds']);
Route::put('/v2/volunteering/accessibility-needs', [\App\Http\Controllers\Api\VolunteerController::class, 'updateAccessibilityNeeds']);
Route::get('/v2/volunteering/community-projects', [\App\Http\Controllers\Api\VolunteerController::class, 'getCommunityProjects']);
Route::post('/v2/volunteering/community-projects', [\App\Http\Controllers\Api\VolunteerController::class, 'proposeCommunityProject']);
Route::get('/v2/volunteering/community-projects/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'getCommunityProject']);
Route::put('/v2/volunteering/community-projects/{id}', [\App\Http\Controllers\Api\VolunteerController::class, 'updateCommunityProject']);
Route::post('/v2/volunteering/community-projects/{id}/support', [\App\Http\Controllers\Api\VolunteerController::class, 'supportCommunityProject']);
Route::delete('/v2/volunteering/community-projects/{id}/support', [\App\Http\Controllers\Api\VolunteerController::class, 'unsupportCommunityProject']);
Route::get('/v2/volunteering/donations', [\App\Http\Controllers\Api\VolunteerController::class, 'getDonations']);
Route::post('/v2/volunteering/donations', [\App\Http\Controllers\Api\VolunteerController::class, 'createDonation']);
Route::get('/v2/volunteering/giving-days', [\App\Http\Controllers\Api\VolunteerController::class, 'getGivingDays']);
Route::get('/v2/volunteering/giving-days/{id}/stats', [\App\Http\Controllers\Api\VolunteerController::class, 'getGivingDayStats']);
