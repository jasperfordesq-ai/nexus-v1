...
/** GET /api/v2/messages/:conversationId — message thread for a conversation */
export function getThread(conversationId: number): Promise<MessageListResponse> {
  return api.get<MessageListResponse>(`${API_V2}/messages/${conversationId}`);
}
