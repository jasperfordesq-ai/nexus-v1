...
{
    private NewsletterTemplate $model;
    ...
    {
        $this->assertEquals('newsletter_templates', $this->model->getTable());
    }
    ...
    public function test_casts_are_correct(): void
    {
        ...
        $this->assertEquals('integer', $casts['use_count']);
        $this->assertEquals('integer', $casts['created_by']);
    }

    public function test_uses_has_tenant_scope(): void
    {
        $traits = class_uses_recursive(NewsletterTemplate::class);
