...
class VolReviewTest extends TestCase
{
    private VolReview $model;

    protected function setUp(): void
    {
        parent::setUp();
        $this->model = new VolReview();
    }

    public function test_table_name(): void
    {
        $this->assertEquals('vol_reviews', $this->model->getTable());
    }
    ...
    {
        $traits = class_uses_recursive(VolReview::class);
