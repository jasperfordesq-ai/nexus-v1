...
class MarketplaceConfigurationServiceTest extends TestCase
{
    public function test_class_exists(): void
    {
        $this->assertTrue(class_exists(\App\Services\MarketplaceConfigurationService::class));
    }
    ...
    {
        try {
            $result = \App\Services\MarketplaceConfigurationService::get('nonexistent_key_xyz', 'default_value');
