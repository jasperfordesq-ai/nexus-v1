 ...
 */
class ReferralServiceTest extends \Tests\Laravel\TestCase
{
    ...
    protected static function createTestData(): void
    {
        ...
        Database::query(
            "INSERT INTO users (tenant_id, email, username, first_name, last_name, name, xp, is_approved, created_at)
             VALUES (?, ?, ?, ?, ?, ?, 0, 1, NOW())",
            [self::$staticTenantId, "referrer_{$timestamp}@test.com", "referrer_{$timestamp}", 'Test', 'Referrer', 'Test Referrer']
        );
        ...
        Database::query(
            "INSERT INTO users (tenant_id, email, username, first_name, last_name, name, xp, is_approved, created_at)
             VALUES (?, ?, ?, ?, ?, ?, 0, 1, NOW())",
            [self::$staticTenantId, "referred_{$timestamp}@test.com", "referred_{$timestamp}", 'Test', 'Referred', 'Test Referred']
        );
