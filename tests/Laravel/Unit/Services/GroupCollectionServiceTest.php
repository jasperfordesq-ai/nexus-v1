...
class GroupCollectionServiceTest extends TestCase
{
    public function test_class_exists(): void
    {
        $this->assertTrue(class_exists(GroupCollectionService::class));
    }

    public function test_has_public_methods(): void
    {
        $ref = new \ReflectionClass(GroupCollectionService::class);
        foreach (['getAll', 'get', 'create', 'update', 'delete', 'setGroups'] as $m) {
    ...
    {
        try {
            $result = GroupCollectionService::getAll();
    ...
    {
        try {
            $result = GroupCollectionService::get(0);
