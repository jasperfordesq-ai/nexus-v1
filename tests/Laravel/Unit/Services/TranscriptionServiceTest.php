...
class TranscriptionServiceTest extends TestCase
{
    ...
    {
        $this->assertTrue(class_exists(\App\Services\TranscriptionService::class));
    }

    public function test_has_public_methods(): void
    {
        $ref = new \ReflectionClass(\App\Services\TranscriptionService::class);
        foreach (['transcribe', 'translate'] as $m) {
