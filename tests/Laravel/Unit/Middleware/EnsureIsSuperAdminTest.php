...
class EnsureIsSuperAdminTest extends TestCase
{
    use DatabaseTransactions;

    private EnsureIsSuperAdmin $middleware;

    protected function setUp(): void
    {
        parent::setUp();
        $this->middleware = new EnsureIsSuperAdmin();
    }
    ...
    public function test_handle_regular_user_returns_403(): void
    {
        ...
        $this->assertStringContainsString('Super admin access required', $data['errors'][0]['message']);
    }

    public function test_handle_regular_admin_returns_403(): void
    {
        $user = User::factory()->create([
            'tenant_id' => $this->testTenantId,
            'role' => 'admin',
