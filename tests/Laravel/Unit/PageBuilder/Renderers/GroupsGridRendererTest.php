...
use App\PageBuilder\Renderers\GroupsGridRenderer;
use Tests\Laravel\TestCase;

class GroupsGridRendererTest extends TestCase
{
    private GroupsGridRenderer $renderer;

    protected function setUp(): void
    {
        parent::setUp();
        $this->renderer = new GroupsGridRenderer();
    }
    ...
    public function test_validate_requires_valid_limit_and_columns(): void
    {
        ...
        $this->assertTrue($this->renderer->validate(['limit' => 1, 'columns' => 1]));
