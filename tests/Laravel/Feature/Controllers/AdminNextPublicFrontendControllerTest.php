...
class AdminNextPublicFrontendControllerTest extends TestCase
{
    ...
    public function test_readiness_reports_shadow_mode_without_cutover(): void
    {
        ...
        $response->assertJsonPath('data.manifest.route_counts.api_backed_public_routes', 68);
        ...
        $response->assertJsonPath('data.cutover_eligibility.counts.remaining_public_routes', 8);
        ...
        $this->assertContains('home', $apiBackedRouteKeys);
        $this->assertContains('changelog', $apiBackedRouteKeys);
        ...
        $this->assertContains('marketplaceCategory', $apiBackedRouteKeys);
        $this->assertContains('municipalityCalendar', $apiBackedRouteKeys);
        $this->assertContains('developers', $apiBackedRouteKeys);
        $this->assertContains('developersAuth', $apiBackedRouteKeys);
        $this->assertContains('developersEndpoints', $apiBackedRouteKeys);
        $this->assertContains('developersWebhooks', $apiBackedRouteKeys);
        $this->assertContains('regionalAnalytics', $apiBackedRouteKeys);
        $this->assertContains('caringCommunity', $apiBackedRouteKeys);
        $this->assertContains('hourPartner', $apiBackedRouteKeys);
        $this->assertContains('hourSocialPrescribing', $apiBackedRouteKeys);
        ...
        $this->assertSame('laravel_public_api', $routeReadinessByKey['home']['content_source']);
        ...
        $this->assertSame(68, $payload['remaining_public_route_work']['counts']['api_backed_public_routes']);
        $this->assertSame(8, $payload['remaining_public_route_work']['counts']['remaining_public_routes']);
