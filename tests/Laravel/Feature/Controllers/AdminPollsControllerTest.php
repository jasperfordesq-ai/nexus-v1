...
/**
 * Feature tests for AdminPollsController.
 *
 * Covers index, show, destroy.
 */
class AdminPollsControllerTest extends TestCase
{
    use DatabaseTransactions;

    // ================================================================
    // INDEX — GET /v2/admin/polls
    // ================================================================
    ...
    public function test_index_returns_200_for_admin(): void
    {
        ...
        $response = $this->apiGet('/v2/admin/polls');
    ...
    public function test_show_returns_404_for_nonexistent_poll(): void
    {
        ...
        $response = $this->apiGet('/v2/admin/polls/99999');
    ...
    public function test_show_returns_403_for_regular_member(): void
    {
        ...
        $response = $this->apiGet('/v2/admin/polls/1');

        $response->assertStatus(403);
    }

    // ================================================================
    // DESTROY — DELETE /v2/admin/polls/{id}
    // ================================================================
    ...
    public function test_destroy_returns_404_for_nonexistent_poll(): void
    {
        ...
        $response = $this->apiDelete('/v2/admin/polls/99999');
    ...
    public function test_destroy_returns_403_for_regular_member(): void
    {
        ...
        $response = $this->apiDelete('/v2/admin/polls/1');
