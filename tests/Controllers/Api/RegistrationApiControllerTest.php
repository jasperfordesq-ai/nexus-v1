...
use Nexus\Controllers\Api\RegistrationApiController;

class RegistrationApiControllerTest extends TestCase
{
    public function testControllerClassExists(): void
    {
        $this->assertTrue(class_exists(RegistrationApiController::class));
    }

    public function testExtendsBaseApiController(): void
    {
        $reflection = new \ReflectionClass(RegistrationApiController::class);
        $this->assertTrue($reflection->isSubclassOf(\Nexus\Controllers\Api\BaseApiController::class));
    }

    public function testHasRegisterMethod(): void
    {
        $reflection = new \ReflectionClass(RegistrationApiController::class);
