...
/**
 * Integration tests for TestRunnerController
 *
 * Tests test suite execution and reporting.
 *
 * @group integration
 * @group admin
 */
class TestRunnerControllerTest extends ApiTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $memberEmail = 'TestRunner_member_' . uniqid() . '@test.local';
        Database::query(
            "INSERT INTO users (tenant_id, email, password_hash, name, first_name, last_name, role, status, is_approved, created_at)
             VALUES (?, ?, ?, 'TestRunner Member', 'TestRunner', 'Member', 'member', 'active', 1, NOW())",
    ...
    {
        $endpoints = [
            ['GET', '/admin-legacy/TestRunner'],
            ['POST', '/admin-legacy/TestRunner/save'],
        ];
