 ...
 *
 * Tests menu builder and management.
 *
 * @group integration
 * @group admin
 */
class MenuControllerTest extends ApiTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $memberEmail = 'Menu_member_' . uniqid() . '@test.local';
        Database::query(
            "INSERT INTO users (tenant_id, email, password_hash, name, first_name, last_name, role, status, is_approved, created_at)
             VALUES (?, ?, ?, 'Menu Member', 'Menu', 'Member', 'member', 'active', 1, NOW())",
    ...
    {
        $endpoints = [
            ['GET', '/admin-legacy/Menu'],
            ['POST', '/admin-legacy/Menu/save'],
        ];
