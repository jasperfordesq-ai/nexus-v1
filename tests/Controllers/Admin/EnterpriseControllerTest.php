...
/**
 * Integration tests for EnterpriseController
 *
 * Tests enterprise features and tenant management.
 *
 * @group integration
 * @group admin
 */
class EnterpriseControllerTest extends ApiTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $memberEmail = 'Enterprise_member_' . uniqid() . '@test.local';
        Database::query(
            "INSERT INTO users (tenant_id, email, password_hash, name, first_name, last_name, role, status, is_approved, created_at)
             VALUES (?, ?, ?, 'Enterprise Member', 'Enterprise', 'Member', 'member', 'active', 1, NOW())",
    ...
    public function testNonAdminCannotAccess(): void
    {
        $endpoints = [
            ...
            ['POST', '/admin-legacy/Enterprise/save'],
        ];
