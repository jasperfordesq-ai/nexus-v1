...
/**
 * Integration tests for SeoController
 *
 * Tests SEO settings and metadata management.
 *
 * @group integration
 * @group admin
 */
class SeoControllerTest extends ApiTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $memberEmail = 'Seo_member_' . uniqid() . '@test.local';
        Database::query(
            "INSERT INTO users (tenant_id, email, password_hash, name, first_name, last_name, role, status, is_approved, created_at)
             VALUES (?, ?, ?, 'Seo Member', 'Seo', 'Member', 'member', 'active', 1, NOW())",
    ...
    {
        $endpoints = [
            ['GET', '/admin-legacy/Seo'],
            ['POST', '/admin-legacy/Seo/save'],
        ];
