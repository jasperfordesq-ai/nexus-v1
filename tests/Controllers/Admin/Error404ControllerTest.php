...
/**
 * Integration tests for Error404Controller
 *
 * Tests 404 error logging and management.
 *
 * @group integration
 * @group admin
 */
class Error404ControllerTest extends ApiTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $memberEmail = 'Error404_member_' . uniqid() . '@test.local';
        Database::query(
            "INSERT INTO users (tenant_id, email, password_hash, name, first_name, last_name, role, status, is_approved, created_at)
             VALUES (?, ?, ?, 'Error404 Member', 'Error404', 'Member', 'member', 'active', 1, NOW())",
    ...
    {
        $endpoints = [
            ['GET', '/admin-legacy/Error404'],
            ['POST', '/admin-legacy/Error404/save'],
        ];
