 ...
 *
 * Tests CMS page creation and management.
 *
 * @group integration
 * @group admin
 */
class PageControllerTest extends ApiTestCase
{
    ...
    public static function setUpBeforeClass(): void
    {
        ...
        $memberEmail = 'Page_member_' . uniqid() . '@test.local';
        Database::query(
            "INSERT INTO users (tenant_id, email, password_hash, name, first_name, last_name, role, status, is_approved, created_at)
             VALUES (?, ?, ?, 'Page Member', 'Page', 'Member', 'member', 'active', 1, NOW())",
    ...
    {
        $endpoints = [
            ['GET', '/admin-legacy/Page'],
            ['POST', '/admin-legacy/Page/save'],
        ];
