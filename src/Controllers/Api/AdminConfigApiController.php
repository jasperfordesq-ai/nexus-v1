...
class AdminConfigApiController extends BaseApiController
{
    ...
    private function getCronJobDefinitions(): array
    {
        return [
            ...
            ['id' => 'update-featured-groups', 'name' => 'Update Featured Groups', 'command' => '/admin/cron/update-featured-groups', 'schedule' => '0 8 * * *', 'category' => 'groups', 'description' => 'Updates featured groups based on ranking algorithms.'],
