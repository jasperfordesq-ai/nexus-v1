        ...
        <ModalBody>
          ...
          <ol className="space-y-3 mt-2">
            <li className="flex items-start gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/15 text-accent dark:text-accent text-xs font-semibold inline-flex items-center justify-center">1</span>
            ...
            <li className="flex items-start gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/15 text-accent dark:text-accent text-xs font-semibold inline-flex items-center justify-center">2</span>
              <span className="text-sm">
            ...
            <li className="flex items-start gap-3">
              <span className="shrink-0 w-6 h-6 rounded-full bg-accent/15 text-accent dark:text-accent text-xs font-semibold inline-flex items-center justify-center">3</span>
              <span className="text-sm">
