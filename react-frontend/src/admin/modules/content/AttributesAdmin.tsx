import { Select, SelectItem, Dropdown, DropdownTrigger, DropdownMenu, DropdownItem, DropdownSection, Button, Chip, Input, Modal, ModalContent, ModalHeader, ModalBody, ModalFooter, Switch } from '@/components/ui';
    ...
    <div>
      ...
      {items.length === 0 && !loading ? (
        <EmptyState
          ...
          actionLabel={t('content.create_attributes')}
        ...
        <DataTable
          ...
          data={items}
          isLoading={loading}
          searchPlaceholder={t('content.search_attributes')}
          onRefresh={loadData}
          emptyContent={t('content.no_data_available')}
        />
      )}
      ...
      <Modal isOpen={modalOpen} onClose={closeModal} size="md">
        <ModalContent>
          ...
          <ModalBody className="gap-4">
            ...
            <Select
              label={t('content.label_categories_optional')}
      ...
      {deleteTarget && (
        <ConfirmModal
          ...
          title={t('content.delete_attributes')}
          message={t('content.delete_attribute_confirm', { name: deleteTarget.name })}
          confirmLabel={t('content.label_delete_item')}
          confirmColor="danger"
          isLoading={deleting}
        />
      )}
