    ...
    <div className="space-y-6">
        ...
        <CardBody className="px-4 py-3">
          <div className="flex gap-3">
            ...
            <div className="space-y-1 text-sm">
              <p className="font-semibold text-accent dark:text-accent">{t('admin.operating_policy.about.title')}</p>
              <p className="text-muted">{t('admin.operating_policy.about.body')}</p>
      ...
      {loading && (
        <div className="flex justify-center py-16">
          <div role="status" aria-busy="true" aria-label={t('common.loading')} className="flex justify-center py-4"><Spinner size="lg" label={t('admin.operating_policy.loading')} /></div>
        </div>
      )}
