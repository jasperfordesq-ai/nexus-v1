...
export default function FederationSystemControls() {
  ...
  const handleTriggerLockdown = async () => {
    if (!lockdownReason.trim()) {
      toast.error(t('super.please_provide_a_reason_for_the_lockdown'));
      return;
    }
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={t('super.federation_system_controls_title')}
        description={t('super.federation_system_controls_desc')}
      />
          ...
          {controls.lockdown_active ? (
            ...
            <div className="space-y-3">
              <Input
                ...
                placeholder={t('super.placeholder_enter_reason_for_emergency_lockdown')}
                value={lockdownReason}
                onValueChange={setLockdownReason}
                variant="bordered"
                description={t('super.desc_this_will_immediately_disable_all_federa')}
              />
              <Button
                color="danger"
                variant="solid"
