...
export default function Partnerships() {
  ...
  const handleSuspend = async (id: number) => {
    ...
    if (res.success) {
      ...
      toast.success(t('super_admin.partnership_suspended'));
    } else {
  ...
  const handleTerminate = async (id: number) => {
    ...
    if (res.success) {
      ...
      setActionPartnership(null);
      toast.success(t('super_admin.partnership_terminated'));
    } else {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        title={t('super_admin.partnerships_title')}
        description={t('super_admin.partnerships_desc')}
      />
      ...
      <Card>
        ...
        <CardBody>
          <Table aria-label={t('super_admin.label_federation_partnerships')} shadow="sm" isStriped>
            <TableHeader>
