...
const FEATURE_MODULES: ModuleDefinition[] = [
  ...
  },
  {
    ...
    configOptions: [
      ...
      { key: 'marketplace.allow_community_delivery', label: 'Allow Community Delivery', description: 'Allow community delivery fulfilment for marketplace listings', type: 'boolean', defaultValue: false, category: 'General' },
      ...
      { key: 'marketplace.promotions_enabled', label: 'Allow Promotions', description: 'Allow explicitly free marketplace promotions; priced promotion checkout remains unavailable', type: 'boolean', defaultValue: false, category: 'Moderation' },
  ...
  },
  {
    id: 'newsletter',
    name: 'Newsletter',
    description: 'Email newsletter campaigns, subscribers, segments, templates, and analytics.',
    icon: Mail,
    type: 'feature',
    configSource: 'tenant_features',
  ...
  },
  {
    ...
    description: 'Auto-translate direct messages between members who speak different languages.',
    icon: Languages,
    type: 'feature',
    configSource: 'tenant_features',
    configOptions: [],
