      ...
      >
        <GlassCard className="p-8 sm:p-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-white/70">
            ...
            <h2 className="text-xl font-semibold text-white mt-8">4. Time Credits</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8">5. Liability</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-white mt-8">6. Changes to Terms</h2>
            <p>
