      ...
      >
        <GlassCard className="p-8 sm:p-12">
          ...
          <div className="prose prose-invert max-w-none space-y-6 text-theme-muted">
            ...
            <h2 className="text-xl font-semibold text-theme-primary mt-8">Information We Collect</h2>
            ...
            <h2 className="text-xl font-semibold text-theme-primary mt-8">How We Use Your Information</h2>
            <ul className="list-disc list-inside space-y-2">
            ...
            <h2 className="text-xl font-semibold text-theme-primary mt-8">Data Sharing</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-theme-primary mt-8">Your Rights</h2>
            <p>
              Under GDPR, you have the right to access, correct, or delete your
              personal data. Contact us to exercise these rights.
            </p>

            <h2 className="text-xl font-semibold text-theme-primary mt-8">Cookies</h2>
            <p>
            ...
            <h2 className="text-xl font-semibold text-theme-primary mt-8">Contact</h2>
            <p>
