...
import { PlatformTermsPage } from './PlatformTermsPage';

describe('PlatformTermsPage', () => {
  beforeEach(() => {
    vi.clearAllMocks();
  });

  it('renders without crashing', () => {
    const { container } = render(<PlatformTermsPage />);
    expect(container.querySelector('div')).toBeTruthy();
  });

  it('renders the page title', () => {
    render(<PlatformTermsPage />);
    expect(screen.getByText('Platform Terms of Service')).toBeInTheDocument();
  });

  it('renders the subtitle', () => {
    render(<PlatformTermsPage />);
    expect(screen.getByText(/terms governing the Project NEXUS platform infrastructure/i)).toBeInTheDocument();
  });
  ...
  it('renders key sections', () => {
    ...
    expect(screen.getByTestId('section-acceptable-use')).toBeInTheDocument();
