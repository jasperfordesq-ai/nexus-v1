...
return [
    ...
    'field_too_long_with_limit'               => ':field must be :max characters or fewer.',
    ...
    'retention_unknown_data_type'   => 'Unknown retention data type.',
    'retention_unknown_action'      => 'Unsupported retention action.',
    'retention_days_range'          => 'Retention period must be between :min and :max days.',
    ...
    'sroi_investment_range'                => 'Investment amount must be between 0 and 100,000,000',
    'sroi_percentage_range'                => 'Deduction percentages must be between 0 and 100',
    'sroi_discount_range'                  => 'Discount rate must be between 0 and 20',
    'sroi_projection_years_range'          => 'Projection years must be between 1 and 10',
    'sroi_outcomes_invalid'                => 'Each outcome needs a name, a non-negative quantity, and a non-negative proxy value (max 25 outcomes)',
    ...
    'geocoding_provider_invalid'           => 'geocoding_provider must be one of: google, nominatim, os_places',
    'google_maps_api_key_invalid'          => 'google_maps_api_key must look like a Google browser API key (AIza followed by 35 characters). Leave blank to use the platform default.',
    'maptiler_api_key_invalid'             => 'maptiler_api_key must be 16–64 alphanumeric characters. Leave blank to use the free OpenStreetMap tile service.',
    'google_maps_map_id_invalid'           => 'google_maps_map_id must be 4–64 alphanumeric characters (and dashes/underscores). Leave blank to use the default styling.',
    ...
    'newsletter_segment_required'          => 'This newsletter targets a segment, but no segment is selected. Choose a segment before sending.',
    ...
    'newsletter_content_too_large'         => 'Newsletter content is too large (512 KB maximum)',
    ...
    'message_attachment_upload_error' => 'Failed to upload attachment',
    'message_attachment_too_large' => 'Attachment is too large (max 10 MB)',
    'message_attachment_invalid_type' => 'That attachment type is not allowed',
    'message_attachment_too_many' => 'You can attach up to :max files',
    ...
    'job_slots_manage_forbidden'           => 'You do not have permission to manage interview slots for this vacancy',
    'job_slots_active_application_required' => 'Only active applications can book interview slots',
    'job_slot_not_found'                   => 'Interview slot not found',
    'job_slot_already_booked'              => 'This interview slot has already been booked',
    'job_slot_passed'                      => 'This interview slot has already passed',
    'job_cannot_book_own_slot'             => 'You cannot book an interview slot for your own vacancy',
    'job_slot_not_booked'                  => 'This interview slot is not booked',
    'job_slots_cancel_forbidden'           => 'You do not have permission to cancel this interview slot',
    ...
    'sso_account_exists_unverified' => 'An account with this email address already exists but is not verified. Verify the account first, then sign in.',
    'sso_provisioning_disabled' => 'Single sign-on is enabled but new account creation is switched off. Contact your administrator.',
    'sso_email_missing' => 'Your identity provider did not share an email address, so an account cannot be created.',
    'sso_provider_not_enabled' => 'This sign-in provider is not enabled for this community.',
    'sso_domain_not_allowed' => 'Your email domain is not permitted to sign in through this provider.',
    'sso_redirect_failed' => 'Single sign-on could not be started. Please try again or use another sign-in method.',
    'sso_login_failed' => 'Single sign-on failed. Please try again or use another sign-in method.',
    ...
    'vol_alert_shift_id_required' => 'Shift ID is required.',
    'vol_alert_message_required' => 'Message is required.',
    'vol_alert_priority_invalid' => 'Priority must be normal, urgent, or critical.',
    'vol_alert_shift_not_found' => 'Shift not found.',
    'vol_alert_opportunity_not_found' => 'Opportunity not found.',
    'vol_alert_create_forbidden' => 'Only coordinators or admins can create emergency alerts.',
    'vol_alert_create_failed' => 'Failed to create emergency alert.',
    ...
    'vol_alert_filled_bell' => ':name has accepted your emergency shift request!',
    'vol_alert_shift_date_upcoming' => 'upcoming',
    'vol_alert_request_bell' => '[:priority] :message - Shift on :date. Can you help?',
    'vol_alert_cancel_not_found' => 'Alert not found or cannot be cancelled.',
    'vol_alert_cancel_failed' => 'Failed to cancel alert.',
    ...
    // ============================================
    'volunteer_opportunity_manage_forbidden' => 'You do not have permission to manage this opportunity',
    'volunteer_opportunity_update_failed' => 'Failed to update opportunity',
    ...
    'volunteer_shift_not_signed_up' => 'You are not signed up for this shift',
    'volunteer_shift_cancel_failed' => 'Failed to cancel shift signup',
    'volunteer_log_date_required' => 'Date is required',
    'volunteer_log_hours_positive' => 'Hours must be greater than 0',
    ...
    'volunteer_verify_own_hours_forbidden' => 'You cannot verify your own logged hours',
    'volunteer_verify_hours_failed' => 'Failed to verify hours',
    'volunteer_org_name_required' => 'Organisation name is required',
    'volunteer_org_name_min_length' => 'Organisation name must be at least 3 characters',
    'volunteer_org_name_max_length' => 'Organisation name must be under 200 characters',
    'volunteer_org_description_min_length' => 'Description must be at least 20 characters',
    'volunteer_org_contact_email_required' => 'Contact email is required',
    'volunteer_org_contact_email_invalid' => 'Please enter a valid email address',
    'volunteer_org_website_invalid' => 'Please enter a valid URL',
    'volunteer_org_name_exists' => 'An organisation with this name already exists',
    'volunteer_org_register_failed' => 'Failed to register organisation',
    'volunteer_review_target_type_invalid' => 'Target type must be organization or user',
    'volunteer_review_rating_range' => 'Rating must be between 1 and 5',
    'volunteer_review_self_forbidden' => 'You cannot review yourself',
    'volunteer_review_already_exists' => 'You have already reviewed this :target',
    'volunteer_review_org_history_required' => 'You must have volunteered with this organisation to leave a review',
    'volunteer_review_user_history_required' => 'You must have volunteered together to leave a review',
    'volunteer_review_create_failed' => 'Failed to create review',
    'group_conversation_name_required' => 'Group name is required',
    'group_conversation_name_too_long' => 'Group name must be 100 characters or less',
    'group_conversation_min_participants' => 'Group must have at least 3 participants',
    'group_conversation_max_participants' => 'Group cannot have more than 50 participants',
    'group_conversation_not_enough_members' => 'Not enough valid members found',
    'group_conversation_not_enough_members_blocked' => 'Not enough valid members (some may be blocked)',
    'group_conversation_not_found' => 'Group conversation not found',
    'group_conversation_admin_only_add' => 'Only admins can add members',
    'group_conversation_already_member' => 'User is already a member',
    'group_conversation_admin_only_remove' => 'Only admins can remove members',
    'group_conversation_user_not_active_member' => 'User is not an active member',
    'group_conversation_admin_only_update' => 'Only admins can update group settings',
    'group_conversation_name_length' => 'Group name must be 1-100 characters',
    'group_conversation_not_member' => 'You are not a member of this group',
    'group_conversation_not_active_member' => 'You are not an active member of this group',
    'group_chatroom_name_required' => 'Chatroom name is required',
    'group_chatroom_name_too_long' => 'Chatroom name must not exceed 100 characters',
    'group_chatroom_member_only_create' => 'You must be a group member to create chatrooms',
    'group_chatroom_not_found' => 'Chatroom not found',
    'group_chatroom_cannot_delete_default' => 'Cannot delete the default chatroom',
    'group_chatroom_delete_forbidden' => 'Only the chatroom creator or a group admin can delete this chatroom',
    'group_chatroom_member_only_post' => 'You must be a group member to post messages',
    'group_chatroom_message_not_in_chatroom' => 'Message not found in this chatroom',
    'group_chatroom_message_delete_forbidden' => 'Only the message author or a group admin can delete this message',
    'group_chatroom_private_channel' => 'This channel is private',
    'group_chatroom_admin_only_pin' => 'Only group admins can pin messages',
    'group_chatroom_admin_only_unpin' => 'Only group admins can unpin messages',
    'group_chatroom_pinned_message_not_found' => 'Pinned message not found',
    'shift_swap_fields_required' => 'from_shift_id, to_shift_id, and to_user_id are required',
    'shift_swap_cannot_swap_self' => 'Cannot swap with yourself',
    'shift_swap_not_signed_up_source' => 'You are not signed up for the source shift',
    ...
    'shift_swap_not_addressed_to_you' => 'This swap request is not addressed to you',
    'shift_swap_response_failed' => 'Failed to process swap response',
    'shift_swap_not_found_or_not_pending' => 'Swap request not found or not pending admin approval',
    'shift_swap_admin_decision_failed' => 'Failed to process admin decision',
    'shift_swap_not_found_or_not_cancellable' => 'Swap request not found or cannot be cancelled',
    'shift_swap_cancel_failed' => 'Failed to cancel swap request',
    'shift_swap_volunteers_unassigned' => 'One or both volunteers are no longer assigned to the requested shifts',
    'shift_swap_double_book_requester' => 'Swap would double-book the requester with an overlapping shift',
    'shift_swap_double_book_recipient' => 'Swap would double-book the recipient with an overlapping shift',
    'shift_swap_apply_failed' => 'Failed to apply swap assignments atomically',
    'shift_swap_execute_failed' => 'Failed to execute shift swap',
    'shift_reservation_min_slots' => 'Must reserve at least 1 slot',
    'shift_reservation_shift_started' => 'Cannot reserve slots for a shift that has already started',
    'shift_reservation_leader_only_reserve' => 'Only group leaders/admins can reserve slots for this group',
    'shift_reservation_slots_available' => 'Only :count slots available',
    'shift_reservation_already_exists' => 'This group already has a reservation for this shift',
    'shift_reservation_create_failed' => 'Failed to create reservation',
    'shift_reservation_not_found' => 'Reservation not found',
    'shift_reservation_leader_only_manage' => 'Only group leaders/admins can manage this reservation',
    'shift_reservation_slots_filled' => 'All reserved slots are filled',
    'shift_reservation_member_already_added' => 'User is already in this group reservation',
    'shift_reservation_add_member_failed' => 'Failed to add member',
    'shift_reservation_member_not_found' => 'Member not found in this reservation',
    ...
    'message_messaging_restricted' => 'Your messaging has been restricted by an administrator',
    'message_blocked_user' => 'You cannot send messages to this user',
    ...
    'subaccount_already_exists' => 'Relationship already exists',
    'subaccount_request_pending' => 'Relationship request is already pending',
    'subaccount_circular' => 'This user already manages your account',
    'subaccount_child_is_parent' => 'This user already manages other accounts and cannot be added as a child',
    'subaccount_parent_is_child' => 'You are a managed account and cannot manage other accounts',
    'subaccount_limit_reached' => 'Maximum number of sub-accounts (:max) reached',
    'subaccount_relationship_not_found' => 'Relationship not found',
    'subaccount_no_activity_permission' => 'You do not have permission to view this activity',
    'skill_category_name_required' => 'Name is required (max 100 chars)',
    'skill_category_has_skills' => 'Category has assigned skills; deactivate instead',
    'skill_name_required_max' => 'Skill name is required (max 100 chars)',
    'skill_already_added' => 'You already have this skill',
    'skill_not_found' => 'Skill not found',
    'shift_waitlist_already_joined' => 'You are already on the waitlist for this shift',
    'shift_waitlist_already_signed_up' => 'You are already signed up for this shift',
    'shift_waitlist_not_on_waitlist' => 'You are not on the waitlist for this shift',
    'shift_waitlist_leave_failed' => 'Failed to leave waitlist',
    'xp_shop_item_not_found' => 'Item not found',
    'xp_shop_cannot_purchase' => 'Cannot purchase',
    'xp_shop_out_of_stock' => 'Out of stock',
