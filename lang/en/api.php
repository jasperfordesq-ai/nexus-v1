...
return [
    ...
    'marketplace_feature_disabled' => 'The marketplace feature is not enabled for this community.',
    'marketplace_merchant_coupons_disabled' => 'Merchant coupons are not enabled for this community.',
    'marketplace_collection_not_found' => 'Marketplace collection not found.',
    'marketplace_inventory_owner_required' => 'You can only update inventory for your own listings.',
    'marketplace_bulk_listing_owner_required' => 'One or more listings do not exist or do not belong to you.',
    'marketplace_csv_row_error' => 'Row :row: :error',
    'marketplace_active_listing_limit' => 'Maximum of :max active listings reached.',
    'marketplace_listing_unavailable_for_purchase' => 'This listing is no longer available for purchase.',
    'marketplace_purchase_own_listing' => 'You cannot purchase your own listing.',
    'marketplace_listing_offer_purchase_required' => 'This listing must be purchased through an accepted offer.',
    'marketplace_listing_cash_price_invalid' => 'This listing does not have a valid cash price.',
    'marketplace_listing_time_credits_unavailable' => 'This listing does not accept time credits.',
    'marketplace_listing_not_approved' => 'This listing has not been approved for purchase.',
    'marketplace_listing_expired' => 'This listing has expired.',
    'marketplace_seller_suspended' => 'This seller is currently suspended.',
    'marketplace_seller_transactions_unavailable' => 'This seller is not available for transactions.',
    'marketplace_seller_profile_not_found' => 'Seller profile not found.',
    'marketplace_shipping_unavailable' => 'Shipping is not available for this listing.',
    'marketplace_shipping_option_not_found' => 'Shipping option not found.',
    'marketplace_shipping_option_unavailable' => 'The selected shipping option is not available.',
    'marketplace_shipping_currency_mismatch' => 'The shipping option currency does not match the listing.',
    'marketplace_shipping_option_required' => 'A valid shipping option is required.',
    'marketplace_community_delivery_unavailable' => 'Community delivery is not available for this listing.',
    'marketplace_local_pickup_unavailable' => 'Local pickup is not available for this listing.',
    'marketplace_paid_shipping_cash_only' => 'Paid shipping is not available for free or time-credit checkout.',
    'marketplace_coupon_loyalty_exclusive' => 'A merchant coupon and loyalty redemption cannot be combined.',
    'marketplace_loyalty_cash_only' => 'Loyalty redemption is only available for cash checkout.',
    'marketplace_coupon_cash_only' => 'Coupons can only be applied to cash purchases.',
    'marketplace_coupon_currency_unsupported' => 'Fixed-value and minimum-order coupons are not available for this currency.',
    'marketplace_coupon_bogo_quantity_required' => 'This buy-one-get-one coupon requires at least two eligible items.',
    'marketplace_offer_amount_invalid' => 'The offer amount must be a positive amount supported by the listing currency.',
    'marketplace_offer_currency_mismatch' => 'The offer currency must match the listing currency.',
    'marketplace_listing_csv_import_limit' => 'The import is limited to :max listings.',
    'marketplace_listing_csv_column_mismatch' => 'Row :row has the wrong number of columns.',
    'marketplace_listing_csv_required_fields' => 'Row :row requires a title and description.',
    'marketplace_listing_csv_length_limit' => 'The title or description in row :row exceeds the length limit.',
    'marketplace_order_not_found' => 'Order not found.',
    'marketplace_order_offer_buyer_required' => 'You can only create orders from your own accepted offers.',
    'marketplace_order_offer_not_accepted' => 'Offer must be accepted before creating an order.',
    'marketplace_order_offer_seller_mismatch' => 'The offer seller does not match the listing seller.',
    'marketplace_order_seller_ship_required' => 'Only the seller can mark an order as shipped.',
    'marketplace_order_buyer_delivery_required' => 'Only the buyer can confirm delivery.',
    'marketplace_order_paid_before_shipping' => 'Order must be paid before marking as shipped.',
    'marketplace_order_delivery_state_invalid' => 'Order must be shipped or paid to confirm delivery.',
    'marketplace_order_cancel_paid_refund_required' => 'Only an unpaid order can be cancelled; a paid order must be refunded.',
    'marketplace_order_delivery_before_completion' => 'Order must be delivered before it can be completed.',
    'marketplace_payment_buyer_required' => 'Only the buyer can initiate payment.',
    'marketplace_payment_not_found' => 'Marketplace payment not found.',
    'marketplace_payment_access_denied' => 'You do not have access to this payment.',
    'marketplace_payment_seller_profile_required' => 'Seller profile not found. Create a seller profile first.',
    'marketplace_payment_user_not_found' => 'User not found.',
    'marketplace_connect_account_create_failed' => 'Failed to create the Stripe Connect account. Please try again.',
    'marketplace_payment_intent_order_state_required' => 'Order must be in pending_payment status to create a payment intent.',
    'marketplace_card_payment_not_required' => 'This order does not require a card payment.',
    'marketplace_checkout_expired' => 'This checkout has expired.',
    'marketplace_checkout_idempotency_conflict' => 'This checkout key was already used for a different purchase request.',
    'marketplace_checkout_mode_conflict' => 'This order has already started with a different card checkout method.',
    'marketplace_payment_currency_unsupported' => 'This currency is not supported for card payments.',
    'marketplace_payment_currency_precision_invalid' => 'The amount uses more decimal places than this currency supports.',
    'marketplace_pickup_reservation_failed' => 'That pickup slot is no longer available. Please choose another slot.',
    'marketplace_seller_onboarding_required' => 'Seller has not completed Stripe onboarding.',
    'marketplace_seller_onboarding_incomplete' => 'Seller Stripe account onboarding is not complete.',
    'marketplace_checkout_order_state_required' => 'Order must be in pending_payment status to start checkout.',
    'marketplace_payment_not_succeeded' => 'Payment has not succeeded. Current status: :status',
    'marketplace_payment_intent_order_not_found' => 'Order not found for this payment intent.',
    'marketplace_payment_intent_order_mismatch' => 'Payment intent does not match the local order.',
    'marketplace_payment_intent_tenant_mismatch' => 'Payment intent does not match the current tenant.',
    'marketplace_payment_amount_mismatch' => 'Payment amount does not match the order total.',
    'marketplace_payment_currency_mismatch' => 'Payment currency does not match the order currency.',
    'marketplace_payment_funds_flow_unsupported' => 'Payment intent has an unsupported funds flow.',
    'marketplace_order_not_awaiting_payment' => 'Order is no longer awaiting payment.',
    'marketplace_successful_payment_not_found' => 'No successful payment found for this order.',
    'marketplace_refund_amount_invalid' => 'Invalid refund amount.',
    'marketplace_payment_intent_missing' => 'Payment has no associated Stripe payment intent.',
    'marketplace_payout_processing' => 'Seller payout is currently being processed; retry the refund shortly.',
    'marketplace_payment_intent_checkout_unlinked' => 'PaymentIntent not yet linked to checkout session',
    'marketplace_dispute_reimbursement_unavailable' => 'Marketplace dispute reimbursement account is unavailable.',
    'marketplace_dispute_transfer_not_found' => 'Marketplace dispute transfer could not be identified.',
    'marketplace_onboarding_link_failed' => 'Failed to generate the onboarding link. Please try again.',
    'marketplace_pickup_slot_not_found' => 'Pickup slot not found.',
    'marketplace_pickup_seller_profile_not_found' => 'Seller profile not found.',
    'marketplace_pickup_slot_end_before_start' => 'Pickup slot end time must be after its start time.',
    'marketplace_pickup_capacity_below_bookings' => 'Capacity cannot be lower than the number of existing bookings.',
    'marketplace_pickup_slot_has_reservations' => 'This pickup slot has active reservations and cannot be deleted.',
    'marketplace_pickup_qr_not_found' => 'Pickup QR code not found.',
    'marketplace_pickup_not_for_seller' => 'This pickup reservation belongs to another seller.',
    'marketplace_pickup_order_not_paid' => 'The order must be paid before pickup can be confirmed.',
    'marketplace_pickup_already_picked_up' => 'This order has already been picked up.',
    'marketplace_pickup_reservation_cancelled' => 'This pickup reservation has been cancelled.',
    'marketplace_pickup_order_not_found' => 'Pickup order not found.',
    'marketplace_pickup_order_not_eligible' => 'This order is not eligible for pickup.',
    'marketplace_pickup_slot_inactive' => 'This pickup slot is inactive.',
    'marketplace_pickup_slot_past' => 'This pickup slot has already started.',
    'marketplace_pickup_slot_full' => 'This pickup slot is full.',
    'marketplace_pickup_slot_seller_mismatch' => 'This pickup slot belongs to a different seller.',
    'marketplace_pickup_duplicate_reservation' => 'This order already has an active pickup reservation.',
    'marketplace_pickup_operation_failed' => 'The pickup request could not be completed.',
    'marketplace_offer_own_listing' => 'Cannot make an offer on your own listing.',
    'marketplace_offer_duplicate_active' => 'You already have an active offer on this listing.',
    'marketplace_offer_not_countered' => 'This offer has not been countered.',
    'marketplace_offer_seller_required' => 'You are not the seller for this offer.',
    'marketplace_offer_status_invalid' => "Cannot act on an offer with status ':status'.",
    'marketplace_offer_expired' => 'This offer has expired.',
    'marketplace_delivery_time_credit_positive' => 'Time credit amount must be greater than 0',
    'marketplace_delivery_time_credit_max' => 'Time credit amount cannot exceed 100 hours',
    'marketplace_delivery_own_order_forbidden' => 'Cannot offer to deliver your own order',
    'marketplace_delivery_order_method_required' => 'This order does not use community delivery.',
    'marketplace_delivery_listing_method_required' => 'This listing does not use community delivery.',
    'marketplace_delivery_offer_duplicate' => 'You already have an active delivery offer for this order',
    'marketplace_delivery_accepted_offer_not_found' => 'No accepted delivery offer found',
    'marketplace_escrow_separate_charge_required' => 'Only a separate platform charge can be recorded as held funds.',
    'marketplace_escrow_captured_charge_required' => 'A captured platform charge is required before funds can be held.',
    'marketplace_escrow_not_held' => "Escrow is not in 'held' status. Current: :status",
    'marketplace_escrow_invalid_release_trigger' => 'Invalid release trigger: :trigger',
    'marketplace_escrow_transfer_ineligible' => 'The held payment is not eligible for a seller transfer.',
    'marketplace_escrow_seller_payout_unavailable' => 'Seller payout account is unavailable.',
    'marketplace_escrow_state_changed' => 'The held-funds state changed while the seller transfer was in progress.',
    'marketplace_escrow_refund_status_invalid' => 'Escrow cannot be refunded from status: :status',
    'marketplace_escrow_payout_refund_flow_required' => 'A scheduled or completed payout must be reversed through the payment refund flow.',
    'marketplace_ai_auto_reply_failed' => 'Failed to generate auto-reply',
    'marketplace_ai_description_failed' => 'Failed to generate description',
    'marketplace_promotions_disabled' => 'Promotions are not enabled for this marketplace.',
    'marketplace_promotions_payment_unavailable' => 'Paid promotion checkout is temporarily unavailable. No promotion was activated.',
    'marketplace_promotion_owner_required' => 'You can only promote your own listings.',
    'marketplace_promotion_type_unknown' => 'Unknown promotion type: :type.',
    'marketplace_promotion_bump_label' => 'Bump to Top',
    'marketplace_promotion_bump_description' => 'Move your listing to the top of search results for 24 hours.',
    'marketplace_promotion_featured_label' => 'Featured Listing',
    'marketplace_promotion_featured_description' => 'Highlight your listing and give it priority placement for 7 days.',
    'marketplace_promotion_category_label' => 'Top of Category',
    'marketplace_promotion_category_description' => 'Pin your listing at the top of its category for 3 days.',
    'marketplace_promotion_homepage_label' => 'Homepage Carousel',
    'marketplace_promotion_homepage_description' => 'Display your listing in the marketplace homepage carousel for 7 days.',
    'marketplace_rating_role_invalid' => 'Role must be buyer or seller.',
    'marketplace_rating_completed_order_required' => 'Can only rate completed orders.',
    'marketplace_rating_buyer_required' => 'You are not the buyer of this order.',
    'marketplace_rating_seller_required' => 'You are not the seller of this order.',
    'marketplace_rating_duplicate' => 'You have already rated this order.',
    'marketplace_rating_range' => 'Rating must be between 1 and 5.',
    'marketplace_coupon_not_found' => 'Coupon not found.',
    'marketplace_coupon_seller_profile_required' => 'You must have an active seller profile to manage coupons.',
    'marketplace_coupon_listing_mismatch' => 'Coupon does not apply to this listing.',
    'marketplace_coupon_seller_mismatch' => 'Coupon does not apply to this seller.',
    'marketplace_coupon_inactive' => 'Coupon is not active.',
    'marketplace_coupon_not_started' => 'Coupon is not yet valid.',
    'marketplace_coupon_expired' => 'Coupon has expired.',
    'marketplace_coupon_minimum_not_met' => 'Order does not meet the minimum value for this coupon.',
    'marketplace_coupon_usage_limit' => 'Coupon has reached its usage limit.',
    'marketplace_coupon_member_limit' => 'You have already used this coupon the maximum number of times.',
    'marketplace_coupon_listing_required' => 'Coupon requires a listing.',
    'marketplace_coupon_category_required' => 'Coupon requires a listing category.',
    'marketplace_coupon_category_mismatch' => 'Coupon does not apply to this category.',
    'marketplace_coupon_qr_invalid' => 'QR token is invalid or has expired.',
    'marketplace_coupon_qr_malformed' => 'QR token payload is malformed.',
    ...
    'marketplace_delivery_buyer_required' => 'Only the buyer can confirm this delivery.',
    'marketplace_delivery_offer_unavailable' => 'This delivery offer is no longer available.',
    'marketplace_delivery_order_unavailable' => 'This marketplace order is no longer available for community delivery.',
    'marketplace_delivery_transaction_description' => 'Community delivery for marketplace order #:order',
    'marketplace_dispute_already_resolved' => 'This dispute has already been resolved.',
    'marketplace_escrow_dispute_active' => 'Funds cannot be released while an active dispute exists for this order.',
    'marketplace_dispute_resolution_claimed' => 'This dispute is already being resolved by another administrator.',
    'image_metadata_strip_failed' => 'The image could not be processed safely. Please choose another file.',
    'marketplace_dispute_invalid_resolution' => 'Choose a valid dispute resolution.',
    'marketplace_dispute_refund_buyer_only' => 'A refund can only be issued in favour of the buyer.',
    'marketplace_dispute_time_credit_full_refund_only' => 'Time-credit orders can only be refunded in full.',
    'marketplace_dispute_resolution_failed' => 'The dispute could not be resolved safely. Please try again.',
    'marketplace_dispute_duplicate' => 'A dispute is already open for this order.',
    'marketplace_dispute_invalid_reason' => 'Choose a valid dispute reason.',
    'marketplace_dispute_order_not_eligible' => 'This order is not eligible for a dispute.',
    'marketplace_dispute_resolved_buyer' => 'The dispute for order #:order was resolved in favour of the buyer.',
    'marketplace_dispute_resolved_seller' => 'The dispute for order #:order was resolved in favour of the seller.',
    'marketplace_dispute_resolved_closed' => 'The dispute for order #:order was closed without a refund.',
    'marketplace_payment_create_failed' => 'The payment could not be created. Please try again.',
    'marketplace_checkout_start_failed' => 'Checkout could not be started. Please try again.',
    'marketplace_order_cancel_payment_pending' => 'This order cannot be cancelled while payment confirmation is pending.',
    'marketplace_free_checkout_not_available' => 'Free checkout is not available for this listing.',
    'marketplace_free_items_disabled' => 'Free marketplace items are disabled for this community.',
    'marketplace_business_sellers_disabled' => 'Business marketplace sellers are disabled for this community.',
    'marketplace_shipping_disabled' => 'Marketplace shipping is disabled for this community.',
    'marketplace_community_delivery_disabled' => 'Community delivery is disabled for this marketplace.',
    'marketplace_hybrid_pricing_disabled' => 'Combined cash and time-credit pricing is disabled for this marketplace.',
    'marketplace_promotions_disabled' => 'Marketplace promotions are disabled for this community.',
    'marketplace_payment_verify_failed' => 'The payment could not be verified. Please try again.',
    ...
    'marketplace_report_acknowledge_invalid_state' => 'This report cannot be acknowledged in its current state.',
    'marketplace_report_resolve_invalid_state' => 'This report cannot be resolved in its current state.',
    'marketplace_report_appeal_invalid_state' => 'This report cannot be appealed in its current state.',
    'marketplace_report_not_appealed' => 'This report does not have an active appeal.',
    'marketplace_time_credit_order_invalid_state' => 'This order cannot be settled with time credits in its current state.',
    'marketplace_time_credit_order_invalid_amount' => 'The time-credit amount for this order is invalid.',
    'marketplace_time_credit_order_description' => 'Marketplace purchase for order #:order',
    'marketplace_time_credit_refund_invalid_state' => 'This time-credit order cannot be refunded in its current state.',
    'marketplace_time_credit_refund_description' => 'Marketplace refund for order #:order — :reason',
    ...
    'super_move_user_passkey_recovery_required' => 'This user cannot be moved until a password sign-in method is configured; passkeys cannot be transferred between communities.',
    ...
    'user_invalid_notification_preference' => 'Invalid value for :field. Use true or false.',
    ...
    'group_exchange_split_unbalanced'       => 'Provider hours (:credits) and receiver hours (:debits) must be equal — an exchange cannot create or destroy time credits. Adjust participant hours and try again.',
    ...
    'saved_item_not_found'                 => 'Item not found',
    ...
    'event_cancelled_by_admin'          => 'Cancelled by an administrator',
    ...
    'group_discussion_locked'           => 'This discussion is locked and cannot accept new replies.',
    'invalid_cursor'                    => 'The pagination cursor is invalid or no longer usable.',
    ...
    'group_capacity_full'                => 'This group has reached its member limit.',
    'group_membership_limit_reached'     => 'You have reached the maximum number of groups you can join.',
    'group_join_request_pending'         => 'Your request to join this group is already pending.',
    'group_invite_revoked'               => 'This invitation has been revoked.',
    'group_invite_email_mismatch'        => 'This email invitation belongs to a different account.',
    'group_invite_pending_limit_reached' => 'This group has reached its pending invitation limit.',
    'group_invite_group_unavailable'     => 'This group is not currently accepting members.',
    'group_marketplace_member_required'  => 'You must be an active group member to view the group marketplace.',
    'idea_team_conversion_forbidden'     => 'You do not have permission to convert this idea team.',
    'idea_team_conversion_conflict'      => 'This idea team has already been converted to a group.',
    'idea_team_conversion_failed'        => 'Failed to convert the idea team.',
    'idea_team_conversion_group_create_failed' => 'Failed to create the group for this idea team.',
    ...
    'group_webhook_events_invalid'      => 'Only supported webhook events may be selected',
    'group_webhook_active_invalid'      => 'The webhook active state must be true or false',
    ...
    'group_scheduled_invalid_payload'   => 'Scheduled post details are invalid',
    'group_scheduled_date_invalid'      => 'The scheduled date must be a valid future date',
    'group_scheduled_recurrence_invalid' => 'Select a valid recurrence pattern',
    'group_scheduled_feature_disabled'  => 'Scheduled publishing is disabled for this group',
    ...
    'credential_delete_failed' => 'We could not safely remove the credential file. The record was kept for follow-up. Please try again or contact your community administrator.',
    ...
    'notification_unsubscribe' => [
        ...
        'fallback_tenant' => 'your community',
        'title_unsubscribed' => 'You have been unsubscribed',
        'title_already' => 'You were already unsubscribed',
        'title_invalid' => 'Unsubscribe link invalid',
    ...
    'group_config_key_required' => 'A Groups configuration key is required.',
    'group_config_key_invalid' => 'Unknown Groups configuration key: :key',
    'group_config_value_required' => 'A Groups configuration value is required.',
    'group_config_settings_required' => 'Groups configuration settings are required.',
    ...
    'admin_image_invalid_type' => 'The file must be a JPEG, PNG, GIF, WebP, or SVG image.',
    'admin_image_size_limit_2mb' => 'The image must be 2 MB or smaller.',
    'billing_checkout_session_failed' => 'The checkout session could not be created. Please try again.',
    'billing_free_downgrade_support_required' => 'Downgrading to a free plan is not available through self-service. Please contact support.',
    'billing_interval_invalid' => 'billing_interval must be either :monthly or :yearly.',
    'billing_portal_session_failed' => 'The billing portal session could not be created. Please try again.',
    'billing_subscription_required_for_portal' => 'An active subscription is required before payment methods can be managed.',
    'caring_pilot_already_launched' => 'This pilot has already been launched.',
    ...
    'glossary_duplicate' => 'A glossary entry for ":term" in :language already exists.',
    'glossary_language_invalid' => 'target_language must be a valid ISO 639 language code, such as en, fr, or de.',
    'glossary_not_found' => 'Glossary entry not found.',
    'glossary_terms_too_long' => 'Glossary terms must be :max characters or fewer.',
    'invalid_date_format' => ':field must use the :format format.',
    'invalid_hex_color' => ':field must be a valid hexadecimal colour, such as :example.',
    'invalid_risk_category' => 'Invalid risk_category value.',
    'landing_card_field_required' => 'Section :section, card :card is missing :field.',
    'landing_card_field_too_long' => 'Section :section, card :card: :field must be :max characters or fewer.',
    'landing_card_invalid' => 'Section :section, card :card must be an object.',
    'landing_card_target_invalid' => 'Section :section, card :card: target_url must be a relative path or an HTTP(S) URL.',
    'landing_card_target_required' => 'Section :section, card :card is missing target_url.',
    'landing_cards_invalid' => 'Section :section: audience_cards.cards must be an array.',
    'landing_cards_limit' => 'Section :section: audience_cards allows at most :max cards.',
    'landing_config_invalid' => 'config must be an object or null.',
    'landing_config_sections_required' => 'config must contain a sections array.',
    'landing_section_fields_required' => 'Section :section is missing required fields: id, type, enabled, order.',
    'landing_section_type_invalid' => 'Section :section has an invalid type: :type',
    'non_empty_array_required' => ':field must be a non-empty array.',
    'platform_super_admin_auth_settings_required' => 'Only platform super administrators may change email verification or administrator approval settings.',
    'stripe_plan_sync_failed' => 'The plan could not be synchronized with Stripe. Please try again.',
    'tenant_settings_storage_unavailable' => 'Tenant settings storage is currently unavailable.',
    'agent_definition_not_found' => 'Agent definition not found.',
    'agent_proposal_approve_failed' => 'The proposal could not be approved.',
    'agent_proposal_edit_approve_failed' => 'The edited proposal could not be approved.',
    'agent_proposal_reject_failed' => 'The proposal could not be rejected.',
    'caring_community_feature_disabled' => 'The Caring Community feature is not enabled for this tenant.',
    'coupon_not_found' => 'Coupon not found.',
    'data_quality_check_unknown' => 'Unknown data-quality check key.',
    'decision_gate_item_unknown' => 'Unknown decision-gate item: :item',
    'decision_gate_update_required' => 'At least one of value, owner, status, or notes must be provided.',
    'field_max_characters' => ':field must be :max characters or fewer.',
    'field_object_required' => ':field must be an object.',
    'field_string_or_null' => ':field must be a string or null.',
    'integration_backlog_already_seeded' => 'The integration backlog already contains items, so defaults were not seeded.',
    'integration_backlog_item_not_found' => 'Integration backlog item not found.',
    'proposal_not_found' => 'Proposal not found.',
    'regional_analytics_required_fields' => 'tenant_id, partner_name, and contact_email are required.',
    'regional_analytics_subscription_not_found' => 'Regional analytics subscription not found.',
    'success_stories_already_seeded' => 'Success stories already exist, so demo cards were not seeded.',
    'success_story_manual_metric' => 'This story uses a manual metric, so there is nothing to refresh.',
    'success_story_metric_refresh_failed' => 'The success-story metric could not be refreshed.',
    'success_story_metric_unavailable' => 'The live metric value is currently unavailable for this story.',
