...
return [
    ...
    'map_provider_invalid' => 'map_provider debe ser uno de: google, openstreetmap',
    'geocoding_provider_invalid' => 'geocoding_provider debe ser uno de: google, nominatim',
    ...
    'sso_invalid_provider_key' => 'La clave del proveedor debe tener entre 2 y 20 letras minúsculas, dígitos, guiones o guiones bajos.',
    'sso_invalid_issuer' => 'La URL del emisor debe ser una dirección https:// válida.',
    'sso_client_id_required' => 'El ID de cliente es obligatorio.',
    'sso_account_exists_unverified' => 'Ya existe una cuenta con esta dirección de correo electrónico, pero no está verificada. Verifica la cuenta primero y luego inicia sesión.',
    'sso_provisioning_disabled' => 'El inicio de sesión único está habilitado, pero la creación de cuentas nuevas está desactivada. Contacta con tu administrador.',
    'sso_email_missing' => 'Tu proveedor de identidad no compartió una dirección de correo electrónico, por lo que no se puede crear una cuenta.',
    'sso_provider_not_enabled' => 'Este proveedor de inicio de sesión no está habilitado para esta comunidad.',
    'sso_domain_not_allowed' => 'Tu dominio de correo electrónico no está permitido para iniciar sesión a través de este proveedor.',
    'sso_redirect_failed' => 'No se pudo iniciar el inicio de sesión único. Inténtalo de nuevo o usa otro método de inicio de sesión.',
    'sso_login_failed' => 'El inicio de sesión único falló. Inténtalo de nuevo o usa otro método de inicio de sesión.',
