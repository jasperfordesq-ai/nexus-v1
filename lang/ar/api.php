...
return [
    ...
    'map_provider_invalid' => 'يجب أن يكون map_provider واحدًا من: google، openstreetmap',
    'geocoding_provider_invalid' => 'يجب أن يكون geocoding_provider واحدًا من: google، nominatim',
    ...
    'sso_invalid_provider_key' => 'يجب أن يتكون مفتاح المزوّد من 2 إلى 20 حرفًا صغيرًا أو أرقام أو شرطات أو شرطات سفلية.',
    'sso_invalid_issuer' => 'يجب أن يكون رابط جهة الإصدار عنوان https:// صالحًا.',
    'sso_client_id_required' => 'معرّف العميل مطلوب.',
    'sso_account_exists_unverified' => 'يوجد حساب بهذا البريد الإلكتروني بالفعل لكنه غير مُوثّق. وثّق الحساب أولًا ثم سجّل الدخول.',
    'sso_provisioning_disabled' => 'تسجيل الدخول الموحّد مفعّل، لكن إنشاء حسابات جديدة متوقف. تواصل مع المسؤول.',
    'sso_email_missing' => 'لم يشارك مزوّد الهوية الخاص بك عنوان بريد إلكتروني، لذا لا يمكن إنشاء حساب.',
    'sso_provider_not_enabled' => 'مزوّد تسجيل الدخول هذا غير مفعّل لهذا المجتمع.',
    'sso_domain_not_allowed' => 'نطاق بريدك الإلكتروني غير مسموح له بتسجيل الدخول عبر هذا المزوّد.',
    'sso_redirect_failed' => 'تعذّر بدء تسجيل الدخول الموحّد. حاول مرة أخرى أو استخدم طريقة تسجيل دخول أخرى.',
    'sso_login_failed' => 'فشل تسجيل الدخول الموحّد. حاول مرة أخرى أو استخدم طريقة تسجيل دخول أخرى.',
    'sso_provider_not_found' => 'لم يتم العثور على مزوّد SSO.',
