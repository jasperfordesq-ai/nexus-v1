...
return [
    ...
    'map_provider_invalid' => 'map_provider deve ser um de: google, openstreetmap',
    'geocoding_provider_invalid' => 'geocoding_provider deve ser um de: google, nominatim',
    ...
    'sso_invalid_provider_key' => 'A chave do fornecedor deve ter entre 2 e 20 letras minúsculas, dígitos, hífenes ou underscores.',
    ...
    'sso_account_exists_unverified' => 'Já existe uma conta com este endereço de e-mail, mas não está verificada. Verifique primeiro a conta e depois inicie sessão.',
    'sso_provisioning_disabled' => 'O início de sessão único está ativado, mas a criação de novas contas está desativada. Contacte o seu administrador.',
    'sso_email_missing' => 'O seu fornecedor de identidade não partilhou um endereço de e-mail, pelo que não é possível criar uma conta.',
    'sso_provider_not_enabled' => 'Este fornecedor de início de sessão não está ativado para esta comunidade.',
    'sso_domain_not_allowed' => 'O seu domínio de e-mail não tem permissão para iniciar sessão através deste fornecedor.',
    'sso_redirect_failed' => 'Não foi possível iniciar o início de sessão único. Tente novamente ou use outro método de início de sessão.',
    'sso_login_failed' => 'O início de sessão único falhou. Tente novamente ou use outro método de início de sessão.',
    'sso_provider_not_found' => 'Fornecedor de SSO não encontrado.',
