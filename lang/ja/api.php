...
return [
    ...
    'sso_invalid_provider_key' => 'プロバイダーキーは2〜20文字の小文字、数字、ハイフン、アンダースコアで構成する必要があります。',
    'sso_invalid_issuer' => '発行者URLは有効な https:// アドレスである必要があります。',
    ...
    'sso_provisioning_disabled' => 'シングルサインオンは有効ですが、新規アカウントの作成は無効になっています。管理者にお問い合わせください。',
    'sso_email_missing' => 'IDプロバイダーがメールアドレスを共有しなかったため、アカウントを作成できません。',
    'sso_provider_not_enabled' => 'このサインインプロバイダーはこのコミュニティでは有効になっていません。',
    'sso_domain_not_allowed' => 'お使いのメールドメインでは、このプロバイダー経由でのサインインは許可されていません。',
    'sso_redirect_failed' => 'シングルサインオンを開始できませんでした。もう一度お試しいただくか、別のサインイン方法をご利用ください。',
    'sso_login_failed' => 'シングルサインオンに失敗しました。もう一度お試しいただくか、別のサインイン方法をご利用ください。',
