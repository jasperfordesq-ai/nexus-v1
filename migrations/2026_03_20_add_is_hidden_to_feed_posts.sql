...
ALTER TABLE feed_posts ADD COLUMN IF NOT EXISTS is_hidden TINYINT(1) NOT NULL DEFAULT 0 AFTER is_pinned;
ALTER TABLE feed_posts ADD INDEX IF NOT EXISTS idx_is_hidden (tenant_id, is_hidden);

ALTER TABLE feed_activity ADD COLUMN IF NOT EXISTS is_hidden TINYINT(1) NOT NULL DEFAULT 0 AFTER is_visible;
