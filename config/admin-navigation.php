        ...
        'sections' => [
            ...
            'smart-systems' => [
                ...
                'children' => [
                    ...
                    ['label' => 'Match Approvals', 'url' => '/admin/match-approvals', 'icon' => 'fa-clipboard-check'],
            ...
            'broker-controls' => [
                ...
                'url' => '/admin/broker-controls',
                'badge' => 'pending_exchanges',
                'children' => [
                    ['label' => 'Dashboard', 'url' => '/admin/broker-controls', 'icon' => 'fa-gauge-high'],
                    ['label' => 'Configuration', 'url' => '/admin/broker-controls/configuration', 'icon' => 'fa-sliders'],
                    ['label' => 'Exchange Requests', 'url' => '/admin/broker-controls/exchanges', 'icon' => 'fa-handshake', 'badge' => 'pending_exchanges'],
                    ['label' => 'Risk Tags', 'url' => '/admin/broker-controls/risk-tags', 'icon' => 'fa-tags'],
                    ['label' => 'Message Review', 'url' => '/admin/broker-controls/messages', 'icon' => 'fa-envelope-open-text', 'badge' => 'unreviewed_messages'],
                    ['label' => 'User Monitoring', 'url' => '/admin/broker-controls/monitoring', 'icon' => 'fa-user-shield'],
                    ['label' => 'Statistics', 'url' => '/admin/broker-controls/stats', 'icon' => 'fa-chart-pie'],
                ],
            ],
        ],
    ],
