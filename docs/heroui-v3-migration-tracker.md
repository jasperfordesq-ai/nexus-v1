...
| 18 | Remove provider, v2 plugin, v2 deps, and aliases | `/docs/react/migration`, `/docs/react/migration/styling` | `npx tsc --noEmit`, `npm run build`, `npm test`, smoke E2E | Blocked | Blocked until all v2 imports are gone |
