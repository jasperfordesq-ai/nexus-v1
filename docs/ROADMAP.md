...
> **Last updated:** 2026-04-28 (32 new items added in two waves: AG32–AG55 from five-founder gap memo, then AG56–AG63 from live agoris.ch Investoren/Gemeinden pages — covering Agoris's stated revenue model that the prior gap analysis missed. Platform coverage of full five-founder vision revised down to ~65% once revenue-layer gaps are counted; coverage of KISS-only deployment remains ~95%)
