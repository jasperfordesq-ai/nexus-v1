...
> **Last updated:** 2026-04-29 (AG64, AG66–AG71, and AG73 implementations added: unified care-provider directory, before/after Gemeinde KPI claim tracking, trust tiers, caregiver/Angehörigen support, project announcement tracking, emergency safety alerts, pilot-region inquiry hardening, and caregiver substitute / cover-care requests with trusted candidate matching. Prior sweep added AG32–AG73 from founder/agoris.ch/KISS claim analysis. Platform coverage of full five-founder vision: ~67%; KISS-only deployment: ~98%)
