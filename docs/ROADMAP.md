...
> **Last updated:** 2026-04-28 (36 new items added in three waves: AG32–AG55 from five-founder gap memo, AG56–AG63 from live agoris.ch Investoren/Gemeinden revenue model, AG64–AG67 from systematic re-read of every page. Platform coverage of full five-founder vision: ~65% (revenue layer + care directory + research framework + before/after KPIs missing); KISS-only deployment: ~95%)
