...
| AG79 | Swiss-native terminology and UX review | Critical | Commission or run a Swiss German/French/Italian review of all KISS/Caring Community resident and coordinator terms before any pilot claim. Scope includes Zeitvorsorge, Betreuung, Nachbarschaftshilfe, Angehörige, Verein, Gemeinde, Kanton, Datenschutz, research consent, safeguarding, and municipal ROI language. Output should be translation-key changes, not hardcoded strings. |
