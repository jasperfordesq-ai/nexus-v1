...
**The most important strategic insight from the live site:** agoris.ch is a HubSpot CMS marketing site built by W4 Marketing AG. There is no app, no signup, no demo, no client login, and no public product. The site's primary CTA is "Jetzt Pilotregion werden!" — they are still recruiting pilot regions. Pilot result claims (30% less effort, 25% more volunteering) are stated without naming a specific pilot region. **This means Agoris does not appear to have a shipped product — they have a vision, a team, a business model, and a marketing site.** That is the asymmetry: NEXUS has 200+ pages, 1,293 API endpoints, 215 services, real production deployments. Agoris has a HubSpot site and four founders.
...
| AG28 | A1 — Regional points (third currency) | High | 📋 **Not yet built** — out of agent quota at 2026-04-28 03:00 (resets 07:00 Europe/Dublin). **Validated 2026-04-28 against live agoris.ch:** home page states verbatim "Mit Zeitbank, Punkten und Engagement schafft Agoris neue Wege" and "Jede Transaktion bleibt in der Region – als Geld, Zeit oder Loyalitätspunkte". Three currencies (CHF / Zeit / Punkte) is core to Agoris's public framing, not just a 99designs brief reference. Planned: tenant-configurable regional points wallet, optional auto-issuance per logged hour, member-to-member transfer toggle, marketplace redemption hook alongside CHF/time credits. |
