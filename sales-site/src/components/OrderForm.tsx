    ...
    <Card className="border border-white/10 bg-white/[0.065] p-5" id="order">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          ...
          <h3 className="mt-2 text-2xl font-black text-white">Send this quote for follow-up.</h3>
          <p className="mt-2 max-w-2xl text-sm leading-6 text-white/58">
            No card capture and no surprise charge. The button creates a structured email to jasper@hour-timebank.ie with your selected plan, add-ons, and launch services.
          </p>
        </div>
      ...
      <div className="mt-5 flex flex-wrap items-center gap-3">
        ...
        <p className="text-sm text-white/48">The final quote is confirmed in writing after discovery.</p>
      </div>
    </Card>
  );
}
