...
const buyerFeatureMap = [
  ...
  {
    buyerQuestion: 'I need broader community modules.',
            ...
            {buyerFeatureMap.map((row) => (
              <article key={row.buyerQuestion} className="grid gap-4 rounded-2xl border border-white/10 bg-black/18 p-5 lg:grid-cols-[0.7fr_1fr_1fr]">
                ...
                <div className="rounded-xl border border-white/10 bg-white/[0.04] p-4">
                  <p className="mb-2 text-sm font-black text-[var(--color-primary)]">Community Edition</p>
                  <p className="text-sm leading-6 text-white/58">{row.communityEdition}</p>
                </div>
                <div className="rounded-xl border border-[color:var(--color-accent)]/20 bg-[color:var(--color-accent)]/8 p-4">
            ...
            {communities.map((community) => (
              <a key={community.url} href={community.url} target="_blank" rel="noopener noreferrer" className="glass-panel rounded-2xl p-5 transition hover:border-[color:var(--color-accent)]/60">
                <div className="flex items-start justify-between gap-4">
                  ...
                  <ExternalLink className="size-4 shrink-0 text-[var(--color-accent)]" />
                </div>
              </a>
            ))}
          </div>
